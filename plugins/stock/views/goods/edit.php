            ...
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                <el-row>
                    <el-col :span="24">
                        ...
                        <el-form-item label="团队奖佣金类型" prop="stock_price_type" required>
                            <el-radio-group v-model="ruleForm.stock_price_type">
                                <el-radio :label="0">百分比</el-radio>
                                <el-radio :label="1">固定金额</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="团队奖励">
                            <el-input v-model.number="ruleForm.stock_price" type="number">
                                <template slot="append" v-if="ruleForm.stock_price_type == 0">%</template>
                                <template slot="append" v-if="ruleForm.stock_price_type == 1">元</template>
                            </el-input>
                        </el-form-item>
                        <el-form-item label="被越级的奖励">
                            <el-input v-model.number="ruleForm.over_stock_price" type="number">
