...
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelGuaranteeTermsInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelInternationalLogisticsInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelNativeLogisticsInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelProductItemInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelTradeTermsInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeKeyValuePair.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaTradeOrderRateInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaInvoiceOrderInvoiceModel.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaTradeCustoms.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaTradeOverseasExtraAddress.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOpenplatformTradeModelOrderBaseInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOrderBizInfo.class.php');
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaOrderDetailCaigouQuoteInfo.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$customsResult=$arrayResult['customs'];
    			    			$this->customs = new AlibabaTradeCustoms();
    			    			$this->customs->setStdResult ( $customsResult);
    		}
    		    	    			    		    		if (array_key_exists ( "overseasExtraAddress", $this->arrayResult )) {
    		$overseasExtraAddressResult=$arrayResult['overseasExtraAddress'];
    			    			$this->overseasExtraAddress = new AlibabaTradeOverseasExtraAddress();
    			    			$this->overseasExtraAddress->setStdResult ( $overseasExtraAddressResult);
    		}
    		...
    		$orderBizInfoResult=$arrayResult['orderBizInfo'];
    			    			$this->orderBizInfo = new AlibabaOrderBizInfo();
    			    			$this->orderBizInfo->setStdResult ( $orderBizInfoResult);
    		}
    		    	    			    		    		if (array_key_exists ( "quoteList", $this->arrayResult )) {
    		$quoteListResult=$arrayResult['quoteList'];
