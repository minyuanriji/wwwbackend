...
include_once ('AlibabaCreateOrderPreviewCybMediaParam/AlibabaCreateOrderPreviewResultModel.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$orderPreviewResusltResult=$arrayResult['orderPreviewResuslt'];
    			...
    			$this->postFeeByDescOfferList = $arrayResult['postFeeByDescOfferList'];
    			}
    		    	    			    		    			if (array_key_exists ( "consignOfferList", $this->arrayResult )) {
    			$this->consignOfferList = $arrayResult['consignOfferList'];
    			}
    		    	    		}
