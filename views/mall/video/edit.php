    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'mall/video/index'})" class="text">视频</span>/视频编辑</div>
                <div flex="dir:right">
                    <div>
            ...
            <el-card v-loading="loading" shadow="never" style="border: none;">
                <el-form :model="form" :rules="FormRules" size="small" ref="form" label-width="120px">
                    ...
                    <el-form-item label="视频链接" prop="url">
                        <el-input placeholder="请输入链接" v-model="form.url">
                            <template slot="append">
                                <com-attachment type="video" :multiple="false" :max="1" @selected="videoUrl">
                    ...
                    <el-form-item label="封面图" prop="pic_url">
                        <com-attachment v-model="form.pic_url" :multiple="false" :max="1">
                        ...
                        <com-image mode="aspectFill" width='80px' height='80px' :src="form.pic_url"></com-image>
                    </el-form-item>
