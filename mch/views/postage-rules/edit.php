...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" v-loading="listLoading"
             body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer"
                                          @click="$navigate({r:'mch/postage-rules/index'})">运费规则</span></el-breadcrumb-item>
                    ...
                    <el-card shadow="never" style="margin-bottom: 12px;width: 650px" v-if="ruleForm.detail"
                        ...
                        <div flex="dir:left box:last">
                            ...
                            <div style="text-align: right">
                                ...
                                <el-button style="margin-left: 0" type="text" @click="deleteDetail(index)" size="small"
                                           circle>
        ...
        <div style="margin-bottom: 1rem;">
            <el-form :model="detail" ref="detail" label-width="100px" :rules="detailRules">
                ...
                <el-form-item prop="list" label="地区选择">
                    <com-district :detail="ruleForm.detail" :edit="detail.list" @selected="selectDistrict"
                                  :level="3"></com-district>
                </el-form-item>
