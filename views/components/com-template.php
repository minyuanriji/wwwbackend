<style>
    ...
    .com-template .form-body {
        padding: 20px 0;
        background-color: #fff;
        margin-bottom: 10px;
    }

    .com-template .form-button {
        margin: 0;
    }

    .com-template .form-button .el-form-item__content {
        margin-left: 0 !important;
    }

    .com-template .button-item {
        padding: 9px 25px;
    }
</style>
<template id="com-template">
    <div class="com-template" v-cloak>
    ...
    Vue.component('com-template', {
        ...
        methods: {
            ...
            handleClick(tab, event) {
                if (['mpwx','bdapp','aliapp','ttapp'].indexOf(tab.name) >= 0) {
                    if (['mpwx','bdapp'].indexOf(tab.name) >= 0) {
            ...
            saveTestUser() {
                request({
                    params: {
                        r: 'plugin/mpwx/mall/template-msg/add-test-user',
                    },
                    method: 'post',
                    data: {
            ...
            getTestUser() {
                request({
                    params: {
                        r: 'plugin/mpwx/mall/template-msg/test-user',
                        platform: this.platform,
                    },
                    method: 'get',
                }).then(e => {
            ...
            testQrcode() {
                ...
                this.$request({
                    params: {
                        r: 'plugin/mpwx/template-msg/qrcode',
                        platform: this.platform,
                    },
                    method: 'get',
                }).then(e => {
