                        ...
                        <el-col :span="24">
                            ...
                            <div style="background-color: #ffffff;padding: 0 0 20px 0;">
                                ...
                                <el-form-item prop="share_pic">
                                    <com-attachment style="margin-bottom:10px" :multiple="false" :max="1"
                                                    @selected="sharePic">
                            ...
                            <div class="form-body" style="padding: 40px;display: flex;">
                                <div class='left-setting-menu'>
                                    ...
                                    <el-form-item :class='active_setting == "is_common_user_member_price" ? "active":""'
                                                  @click.native='chooseSetting("is_common_user_member_price")' label="VIP会员会员价"
                                ...
                                <div style='background-color: #F3F5F6;padding: 30px;border-radius: 10px;'
                                    ...
                                    <div class="item-img">
                                        ...
                                        <com-image v-if='active_setting == "is_sales"' mode="aspectFill"
                                                   ...
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_common_user_member_price"' mode="aspectFill"
                                                   src="statics/img/mall/price_show_2.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_member_user_member_price"' mode="aspectFill"
                                                   src="statics/img/mall/price_show.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_distribution_price"' mode="aspectFill"
                                                   src="statics/img/mall/distribution_show.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        ...
                                        <com-image v-if='active_setting == "is_official_account"' mode="aspectFill"
                                                   ...
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image  v-if='active_setting == "is_icon_members_grade"' mode="aspectFill" src="statics/img/mall/icon_members_grade.png"
                                                    style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <!-- 超级会员卡图 -->
                                        <com-image v-if='active_setting == "is_icon_super_vip" && is_svip' mode="aspectFill" src="statics/img/mall/is_icon_super_vip.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_show_normal_vip" && is_svip' mode="aspectFill" src="statics/img/mall/member-price.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_show_super_vip" && is_svip' mode="aspectFill" src="statics/img/mall/member-price.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                        <com-image v-if='active_setting == "is_goods_video"' mode="aspectFill" src="statics/img/mall/goods-video.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></com-image>
                                    </div>
                                </div>
                            </div>
                        ...
                        <el-col :span="24">
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                ...
                                <el-form-item>
                                    ...
                                    <com-image style="width: 80px; height: 80px;"
                                               :src="ruleForm.setting.small_app_pic"></com-image>
                                </el-form-item>
                            </div>
