        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="240px">
                ...
                <el-form-item label="配送人员" prop="mobile">
                    ...
                    <el-button type="text" @click="mobileClick(-1)">+<span style="color: #353535;">新增配送人员</span></el-button>
                    <el-dialog
                            title="配送人员"
                ...
                <el-form-item label="计费方式" prop="price_mode">
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-input class="start_price" placeholder="价格" type="number" v-model="ruleForm.price_mode.start_price">
                                <template slot="append">元</template>
                            </el-input>
                        </el-col>
                    </el-row>
                    <el-row style="margin-top: 12px;">
                        <el-col :span="12">
                            <el-input class="start_price" placeholder="公里数" type="number" v-model="ruleForm.price_mode.add_distance">
                                <template slot="prepend">超出起步范围</template>
                                <template slot="append">公里内</template>
                            </el-input>
                        </el-col>
                        <el-col :span="12">
                            <el-input class="start_price" placeholder="价格" type="number" v-model="ruleForm.price_mode.add_price">
                    ...
                    <el-row style="margin-top: 12px;">
                        ...
                        <el-col :span="12">
                            <el-input class="start_price" placeholder="价格" type="number" v-model="ruleForm.price_mode.fixed">
                ...
                <el-form-item label="配送范围设置" prop="range" required>
                    <div class="com-map" id="delivery-map" style="width: 662px;height: 500px;"
