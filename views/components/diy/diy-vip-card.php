                        ...
                        <el-form-item class="diy-user-label" label="未购买用户" prop="buy_user">
                            <el-form-item label="背景图" prop="buy_bg">
                                <div style="position: relative">
                                    <com-attachment :multiple="false" :max="1" @selected="buyPicUrl">
                            ...
                            <el-form-item label="按钮颜色" prop="buy_btn_bg_color">
                                <el-color-picker class="diy-color-picker" style="margin-top: 10px;" size="small" v-model="data.buy_btn_bg_color"></el-color-picker>
                            </el-form-item>
                    ...
                    <el-form label-position="left">
                        <el-form-item class="diy-user-label" label="已购买用户" prop="renew_user">
                            <el-form-item label="背景图" prop="renew_bg">
                                <div style="position: relative">
                                    <com-attachment :multiple="false" :max="1" @selected="renewPicUrl">
                                        <el-tooltip class="item" effect="dark" content="建议尺寸:702*120" placement="top">
                                            <el-button size="mini">选择文件</el-button>
                                        </el-tooltip>
                                    </com-attachment>
                            ...
                            <el-form-item label="按钮颜色" prop="renew_btn_bg_color">
                                <el-color-picker class="diy-color-picker" style="margin-top: 10px;" size="small" v-model="data.renew_btn_bg_color"></el-color-picker>
                            </el-form-item>
                        </el-form-item>
                    </el-form>
                </template>
