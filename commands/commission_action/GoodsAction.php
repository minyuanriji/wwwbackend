...
class GoodsAction extends Action{
    ...
    private function doNew(){
        ...
        $query->select([
            ...
            "od.total_price", "g.profit_price", "gw.name","g.first_buy_setting", "g.enable_commisson_price",
        ...
        $newPriceLogFunc = function($userId, $isLianc, $price, $totalIncome, $ruleData, $orderDetailData){
            ...
            if(!$priceLog){ //没有生成过再去生成
                ...
                try {
                    ...
                    $this->controller->commandOut("[GoodsAction]生成分佣记录 [ID:".$priceLog->id."]");
        ...
        try {
            ...
            $parentDatas = $this->controller->getCommissionParentRuleDatas($orderDetailData['user_id'],
