            ...
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="专题样式">
                    <el-radio-group v-model="data.style">
                        <el-radio label="normal">简易模式</el-radio>
<!--                        <el-radio label="list">列表模式</el-radio>-->
                ...
                <template v-else>
                        ...
                        <el-card shadow="never" class="topic-edit-options" style="margin-bottom: 24px" v-for="(cat, catIndex) in data.list"
                            ...
                            <div @click="selectCat(catIndex)">
                                ...
                                <div flex="box:first" v-else>
                                    ...
                                    <div>
                                        <com-dialog-select url="mall/topic/index" :multiple="true" @close="topicShow = false"
                    ...
                    <el-form-item label="专题列表" v-else>
                        <com-dialog-select url="mall/topic/index" :multiple="true" @selected="selectTopic" @close="topicShow = false"
                                           title="选择专题" list-key="title" :display="topicShow" style="height: 0;">
                        </com-dialog-select>
                        <el-button size="mini" @click="topicShow = true">添加专题</el-button>
