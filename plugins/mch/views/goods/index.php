<?php
Yii::$app->loadComponentView('com-goods-list');
?>
<style>
</style>
<div id="app" v-cloak>
        ...
        <template slot="column-col-first">
            <el-table-column prop="store.name" label="店铺信息" width="200">
                <template slot-scope="scope">
                    <div flex="box:first">
                        <com-image style="margin-right: 5px" width="25" height="25" mode="aspectFill"
                                   :src="scope.row.store.cover_url"></com-image>
                        <com-ellipsis :line="1">{{scope.row.store.name}}</com-ellipsis>
                    </div>
                </template>
            </el-table-column>
        </template>
