...
include_once ('AlibabaTradeUploadRefundVoucherParam/AlibabaOceanOpenplatformBizTradeResultOrderRefundUploadVoucherResult.class.php');
...
class AlibabaOceanOpenplatformCommonOrderRefundUploadVoucherResult extends SDKDomain {
    ...
    */
    ...
    /**
     * 设置成功结果     
     * @param AlibabaOceanOpenplatformBizTradeResultOrderRefundUploadVoucherResult $result     
     * 参数示例：<pre> </pre>     
     * 此参数必填     */
