    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <div style="margin-bottom: 20px;">请选择搜索方式
                ...
                >
                    <el-select style="width: 130px" slot="prepend" v-model="searchData.keyword_1">
            ...
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column prop="user.nickname" label="收益人信息" width="400">
                    <template slot-scope="scope">
                        <com-image mode="aspectFill"
                                   style="float: left;margin-right: 8px"
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'mall/commission/hotel-scan-code-log',
                        page: this.page,
