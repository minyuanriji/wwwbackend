        ...
        <div class="form-body">
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                ...
                <el-form-item label="用户头像" prop="virtual_avatar">
                    <com-attachment :multiple="false" :max="1" @selected="virtualAvatar">
                        <el-tooltip class="item" effect="dark" content="建议尺寸:100 * 100" placement="top">
                            <el-button size="mini">选择文件</el-button>
                        </el-tooltip>
                    </com-attachment>
                    <com-image mode="aspectFill" width='80px' height='80px' :src="form.virtual_avatar"></com-image>
                </el-form-item>
                ...
                <el-form-item label="评价图片" prop="pic_url">
                    ...
                    <div flex="dif:left">
                        <template v-if="form.pic_url.length">
                            <com-image v-for="item in form.pic_url" :key="item.id" mode="aspectFill" width="80px" height='80px' :src="item"></com-image>
                        </template>
                        <template v-else>
                            <com-image mode="aspectFill" width="80px" height='80px'></com-image>
                        </template>
                    </div>
                </el-form-item>
...
<script>
Vue.component('com-comment-edit', {
    template: '#com-comment-edit',
    props: {
        sign: {
            type: String,
            default: '',
