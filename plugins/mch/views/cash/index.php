        ...
        <div class="table-body">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <div flex="cross:center">
                            <com-image width="25" height="25" :src="scope.row.mch.store.cover_url"></com-image>
                            <com-ellipsis style="margin-left: 10px;" :line="1">{{scope.row.mch.store.name}}
                            </com-ellipsis>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <div>
                            <com-ellipsis style="margin-left: 10px;" :line="1">{{scope.row.mch.user ? scope.row.mch.user.nickname : ''}}
                            </com-ellipsis>
                            <com-ellipsis style="margin-left: 10px;" :line="1">电话:{{scope.row.mch.mobile}}
                            </com-ellipsis>
                        </div>
                    </template>
                </el-table-column>
