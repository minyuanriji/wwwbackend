    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->senderPhone = $arrayResult['senderPhone'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderMobile", $this->arrayResult )) {
    			$this->senderMobile = $arrayResult['senderMobile'];
    			}
    			...
    			$this->senderProvinceCode = $arrayResult['senderProvinceCode'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderCityCode", $this->arrayResult )) {
    			$this->senderCityCode = $arrayResult['senderCityCode'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderCountyCode", $this->arrayResult )) {
    			$this->senderCountyCode = $arrayResult['senderCountyCode'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderAddress", $this->arrayResult )) {
    			$this->senderAddress = $arrayResult['senderAddress'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderProvince", $this->arrayResult )) {
    			$this->senderProvince = $arrayResult['senderProvince'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderCity", $this->arrayResult )) {
    			$this->senderCity = $arrayResult['senderCity'];
    			}
    		    	    			    		    			if (array_key_exists ( "senderCounty", $this->arrayResult )) {
    			$this->senderCounty = $arrayResult['senderCounty'];
    			}
    		    	    		}
