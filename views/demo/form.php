    ...
    <el-card v-loading="loading" shadow="hover">
        ...
        <el-form :model="form" :rules="rules" ref="form">
            ...
            <el-form-item label="单张图片" prop="single_pic">
                <com-attachment @selected="singleSelected">
                    <el-button type="text" icon="el-icon-picture-outline">选择图片</el-button>
                </com-attachment>
                <com-gallery v-if="form.single_pic" :list="[form.single_pic]"></com-gallery>
            </el-form-item>

            <!-- 多张图片选择 -->
            <el-form-item label="多张图片" prop="multiple_pic">
                <com-attachment :multiple="true" :max="2" @selected="multipleSelected">
                    <el-button type="text" icon="el-icon-picture-outline">选择图片</el-button>
                </com-attachment>
                <com-gallery v-if="form.multiple_pic" :show-delete="true" @deleted="picDeleted"
                             :list="form.multiple_pic"></com-gallery>
            </el-form-item>

            <!-- 嵌套Dialog -->
            <el-form-item label="嵌套Dialog" >
                <el-button @click="dialogInDialogVisible = true">嵌套Dialog</el-button>
            </el-form-item>

            <!-- 视频选择 -->
            <el-form-item label="嵌套Dialog" prop="name">
                <com-attachment v-model="form.video_url" type="video">
            ...
            <el-form-item label="简化版图片上传" prop="single_pic">
                <com-attachment @selected="singleSelected" :simple="true" v-model="form.simple_pic">
                    <el-button type="text" icon="el-icon-picture-outline">选择图片</el-button>
                </com-attachment>
