...
<div id="com-offer-price" v-cloak>
            ...
            <el-form ref="detail" @submit.native.prevent :model="detail" label-width="150px" :rules="dialogRules">
                ...
                <el-form-item label="地区选择" prop="list">
                    <div style="margin-bottom: 1rem;">
                        <com-district :detail="ruleForm.detail" @selected="selectDistrict" :level="3"
                                      :edit="editDistrict.list"></com-district>
...
<script>
    Vue.component('com-offer-price', {
        template: '#com-offer-price',
        data() {
