...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <com-header :url="url" :new-search="JSON.stringify(search)">分销排行</com-header>
        </div>
            ...
            <el-table v-loading="loading" @sort-change="changeSort"
                ...
                <el-table-column prop="name" label="分销商名称" width="180">
                    <template slot-scope="scope">
                        <div flex="dir:left">
                            <com-image style="margin-right: 10px;float: left;" :src="scope.row.avatar" width="48px"
                                       height="48px">
                            </com-image>
                            <div flex="dir:top">
                                <div>
                ...
                <el-table-column prop="total_childs" width="200" label="总下级数" sortable='custom'
                                 :label-class-name="chooseProp == 'total_childs' ? 'sort-active': ''">
                </el-table-column>
                <el-table-column prop="total_order" width="200" label="分销订单数量" sortable='custom'
                                 :label-class-name="chooseProp == 'total_order' ? 'sort-active': ''">
                </el-table-column>
                <el-table-column prop="total_price" width="200" label="总佣金" sortable='custom'
                                 :label-class-name="chooseProp == 'total_price' ? 'sort-active': ''">
                    <template slot="header" slot-scope="scope">
                        <span>总佣金</span>
                        <el-tooltip class="item" effect="dark" content="包括已完成订单和未完成订单以及可提现和未提现佣金" placement="bottom">
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'mall/distribution-statistics/index',
