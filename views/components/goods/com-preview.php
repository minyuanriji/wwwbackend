<style>
    .com-preview .el-scrollbar__wrap {
        overflow-x: hidden;
    }
    ...
    .com-preview .text-price::before {
        content: '￥';
        font-size: 60%;
    }

    .com-preview .text-price-all::before {
        content: '￥';
        font-size: 100%;
    }
    ...
    .com-preview .share .el-image {
        height: 20px;
        width: 20px
    }

    .com-preview .share > div {
        color: #666666;
        margin-top: 6px
    }

    .com-preview .services {
        margin: 6px 5px;
    }

    .com-preview .services .el-image {
        height: 12px;
        width: 12px;
    }

    .com-preview .services > span {
        color: #666666;
        margin-left: 6px;
    }
    ...
    .com-preview .goods .origin-price {
        color: #999999;
        text-decoration: line-through;
        margin-left: 12px
    }

    .com-preview .goods .virtual-sales {
        color: #999999;
        margin-top: 6px
    }
    .com-preview .goods .goods-name {
    ...
    .com-preview .detail img {
        width: 100%;
        height: 100%;
    }

    .com-preview .detail p {
        margin: 0;
        padding-bottom:0.3em;
    }

    .com-preview .detail table {
        width: 100% !important;
    }
</style>
<template id="com-preview">
