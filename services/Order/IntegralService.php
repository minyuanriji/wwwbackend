...
class IntegralService
{
    ...
    private $user_use_integral = 0; //用户已使用金豆券
    private $integral_status = 1; //后台金豆券开启状态
    private $integral_price = 1; //多少金豆券抵扣一元;金豆券比例
    private $use_integral; //用户是否使用金豆券
    private $type; //订单预览还是订单提交
    private $total_goods_price;//订单的商品总价

    private $user_integral; //用户金豆券
    private $user_remaining_integral; //用户剩余金豆券

    private $integral_service_fee = 0; //金豆券总服务费

    /**
     * IntegralService constructor.
     * @param $item
     * @param $user_integral //用户可用金豆券
     * @param $type
     * @param $use_integral //用多少金豆券
