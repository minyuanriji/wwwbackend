<style>
    .com-area-limit .form-button {
        margin: 0 !important;
    }

    .com-area-limit .form-button .el-form-item__content {
        margin-left: 0 !important;
    }

    .com-area-limit .button-item {
        padding: 9px 25px;
    }
    ...
    .com-area-limit .el-dialog {
        min-width: 800px;
    }
</style>

<template id="com-area-limit">
    <div>
...
<script>
    Vue.component('com-area-limit', {
        template: '#com-area-limit',
        props: {
            value: {
                type: Array,
                default: [{list: []}],
