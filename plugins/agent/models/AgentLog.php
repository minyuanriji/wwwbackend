...
/**
 * This is the model class for table "{{%plugin_agent_log}}".
 *
 * @property int $id
 ...
 */
class AgentLog extends BaseActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'user_id', 'common_order_detail_id', 'is_price', 'status', 'created_at', 'deleted_at', 'updated_at', 'is_delete', 'level', 'child_id','order_id'], 'integer'],
            [['price'], 'number'],
        ];
    }
    ...
    {
        return $this->hasOne(User::className(), ['child_id' => 'id']);
    }
