 ...
 * @property int $agent_order_id 分销订单id
 ...
 * @property AgentOrder $agentOrder
 */
class AgentCommissionLog extends BaseActiveRecord
{
    ...
    {
        return '{{%plugin_agent_commission_log}}';
    }
    ...
    {
        return [
            [['user_id', 'mall_id', 'type', 'money','commission', 'desc','agent_order_id', 'created_at'], 'required'],
            [['user_id', 'mall_id', 'type','level','agent_order_id','status','order_id','is_pay'], 'integer'],
    ...
    {
        return $this->hasOne(AgentOrder::className(), ['id' => 'agent_order_id']);
    }
}
