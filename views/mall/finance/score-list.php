...
<div id="app" v-cloak>
	<el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
	    <div slot="header">
	        <div>
				<el-button :type="pageName=='plan' ? 'primary' : '' "  @click="toOtherPage('mall/finance/score-plan')">积分券发放计划</el-button>
				<el-button :type="pageName=='detail' ? 'primary' : '' " @click="toOtherPage('mall/finance/score-list')">积分券发放明细</el-button>
				<el-button :type="pageName=='detail' ? 'primary' : '' " @click=" $navigate('mall/finance/score-list')">积分券发放明细</el-button>
				<el-button :type="pageName=='dynamic' ? 'primary' : '' ">限时积分券</el-button>
	        </div>
	    </div>
	</el-card>
    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column prop="integral_num" label="金豆券数量"></el-table-column>
                <el-table-column  label="金豆券类型">
                    <template slot-scope="scope">
