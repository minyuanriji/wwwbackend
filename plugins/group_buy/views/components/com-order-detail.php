            ...
            <div class="table-body" v-loading="loading">
                <el-card class="com-order-status" shadow="never">
                    <el-steps v-if="isShowSteps" :active="active" align-center>
                        ...
                        <el-step :title="active > 1 && order.is_pay == 1 ? '拼单中':'未付款'"
                ...
                <div class="action-box" flex="dir:right">
                    <div>
                        ...
                        <!-- 发货 -->
                        <template v-if="order.status == 1 && order.sale_status == 0 && order.active.status==2">
                            <!-- 正常发货 -->
                            <el-button
...
<script>
    Vue.component('com-order-detail', {
        ...
        props: {
            getDetailUrl: {
                type: String,
                default: 'plugin/group_buy/mall/order/api-detail'
            },
            getOrderListUrl: {
                type: String,
