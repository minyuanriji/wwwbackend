<style>
    ...
    .area-batch .batch-box {
        margin-left: 10px;
    }

    .area-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .area-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .area-batch .batch-title {
        font-size: 18px;
    }

    .area-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .area-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .area-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .area-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .area-batch .batch-box-right {
        padding: 5px 20px;
    }

    .area-batch .express-dialog .el-dialog {
        min-width: 250px;
    }
</style>


<template id="area-batch">
    <div class="area-batch" flex="dir:left cross:center">
                            ...
                            <el-form-item label="分销商等级">
                                <el-select size="small" v-model="level" class="select">
                                    <el-option :key="index" :label="item.name" :value="item.level"
                                               v-for="(item, index) in areaLevelList"></el-option>
                                </el-select>
                            </el-form-item>
                        </template>
                    </el-form>
...
<script>
    Vue.component('area-batch', {
        ...
        props: {
            ...
            batchLevelUrl: {
                type: String,
                default: 'plugin/area/mall/area/batch-level',
            },
            areaLevelList: Array,
        },
        data() {
        ...
        created(){
                 console.log(this.areaLevelList);
