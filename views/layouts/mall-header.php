        ...
        <header class="mall-header" flex="box:last">
            ...
            <el-menu mode="horizontal" menu-trigger="click">
                ...
                <el-submenu index="2" v-if="mall && user" popper-class="mall-header-menu">
                    ...
                    <el-menu-item v-if="(user.admin_type == 1 || user.admin_type == 2) && user.mch_id == 0"
                                  index="2-1" @click="goBackToSystem">返回系统
                    </el-menu-item>
                    <el-menu-item
                            v-if="user.admin_type == 3 && user.mch_id == 0 && updatePasswordStatus"
                            index="2-3" @click="updatePassword">修改密码
                    </el-menu-item>
                    <el-menu-item v-if="user.admin_type == 3 || user.mch_id"
