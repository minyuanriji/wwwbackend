    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="150px">
            <div class="form-body">
                ...
                <el-form-item label="允许购买区域" v-if="ruleForm.is_enable" prop="detail" required>
                    <el-button style="margin-left: 20px;" size="small" v-if="ruleForm.detail[0].list.length == 0"
                               type="text" @click="openDistrict"><i class="el-icon-plus">添加地区</i>
                    </el-button>
                    <el-card style="margin-left: 20px;position: relative" shadow="never"
        ...
        <el-dialog title="选择地区" :visible.sync="dialogVisible" width="50%">
            <div style="margin-bottom: 1rem;">
                <com-district :edit="detail" @selected="selectDistrict" :level="3"></com-district>
