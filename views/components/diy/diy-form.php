...
<template id="diy-form">
    <div class="diy-form">
            ...
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item v-if="data.showImg" label="图片位置">
                    <div class="background-position" flex="main:justify wrap:wrap">
                        <div @click="data.position=1;position='top left'" :class="data.position==1?'active':''"></div>
                        <div @click="data.position=2;position='top center'" :class="data.position==2?'active':''"></div>
                        <div @click="data.position=3;position='top right'" :class="data.position==3?'active':''"></div>
                        <div @click="data.position=4;position='center left'" :class="data.position==4?'active':''"></div>
                        <div @click="data.position=5;position='center center'" :class="data.position==5?'active':''"></div>
                        <div @click="data.position=6;position='center right'" :class="data.position==6?'active':''"></div>
                        <div @click="data.position=7;position='bottom left'" :class="data.position==7?'active':''"></div>
                        <div @click="data.position=8;position='bottom center'" :class="data.position==8?'active':''"></div>
                        <div @click="data.position=9;position='bottom right'" :class="data.position==9?'active':''"></div>
                    </div>
                </el-form-item>
        ...
        <el-dialog title="表单内容设置" :visible.sync="visible">
            <com-form :value.sync="list"></com-form>
            <div slot="footer">
                <el-button size="small" type="primary" @click="addForm">确 定</el-button>
            </div>
        </el-dialog>
<!--         <el-dialog title="表单提交设置" width="20%" :visible.sync="submitDialog">
            <el-form ref="form" label-width="140px">
                <el-form-item label-width="140px" label="提交间隔类型">
                    <el-radio-group size="small" v-model="data.type">
                        <el-radio :label="0">时间间隔</el-radio>
                        <el-radio :label="1">提交次数</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item label-width="140px" :label="data.type == 0 ? '时间间隔(分钟)':'提交次数'">
                    <el-input type="number" size="small" v-model="data.times"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer">
                <el-button size="small" type="primary" @click="submitDialog=false">确 定</el-button>
            </div>
        </el-dialog> -->
    </div>
</template>
