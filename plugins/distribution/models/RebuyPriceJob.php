...
/**
 * This is the model class for table "{{%plugin_distribution_rebuy_price_job}}".
 *
 * @property int $id
 ...
 */
class RebuyPriceJob extends BaseActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%plugin_distribution_rebuy_price_job}}';
    }
