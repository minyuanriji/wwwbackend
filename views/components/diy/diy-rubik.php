                    ...
                    <el-tab-pane label="图片上传" name="second">
                        ...
                        <template v-else>
                            <el-card shadow="never">
                                <el-form-item label="图片上传">
                                    <com-attachment :multiple="false" :max="1" v-model="data.list[rubik].pic_url">
                                        <el-button size="mini">选择图片</el-button>
                                    </com-attachment>
                                    <com-gallery :multiple="false" width="100px" height="100px"
                        ...
                        <el-form-item label="热区划分">
                            <com-hotspot :multiple="true" :pic-list="data.list" :hotspot-array="data.hotspot"
    ...
    Vue.component('diy-rubik', {
        ...
        data() {
            return {
                ...
                activeName: 'first',
                link: '',
                img: '<?=$diyIconPath?>/default_img.png',
                isMove: false,
                zoom: 2, // 缩放倍数
                style_list: [
                    {
                        ...
                        icon: '<?=$diyIconPath?>/components/rubik-0.png',
                    },
                    {
                        name: '2张图',
                        height: 360,
                       ...
                       icon: '<?=$diyIconPath?>/components/rubik-1.png',
                    },
                    {
                        name: '3张图',
                        height: 360,
                       ...
                       icon: '<?=$diyIconPath?>/components/rubik-2.png',
                    },
                    {
                        name: '4张图',
                        height: 360,
                       ...
                       icon: '<?=$diyIconPath?>/components/rubik-3.png',
                    },
                    {
                        name: '2张图平分',
                        height: 240,
                       ...
                       icon: '<?=$diyIconPath?>/components/rubik-4.png',
                    },
                    {
                        name: '3张图平分',
                        height: 240,
                       ...
                       icon: '<?=$diyIconPath?>/components/rubik-5.png',
                    },
                    {
                        name: '4张图左右平分',
                        height: 186,
                    ...
                    },
                    {
                      ...
                      icon: '<?=$diyIconPath?>/components/rubik-7.png',
                    },
                    {
                        name: '自定义魔方',
                        height: 372,
                      ...
                      icon: '<?=$diyIconPath?>/components/rubik-8.png',
                    },
                ]
            };
        },
