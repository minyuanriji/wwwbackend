<style>
    ...
    .boss-batch .batch-box {
        margin-left: 10px;
    }

    .boss-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .boss-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .boss-batch .batch-title {
        font-size: 18px;
    }

    .boss-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .boss-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .boss-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .boss-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .boss-batch .batch-box-right {
        padding: 5px 20px;
    }

    .boss-batch .express-dialog .el-dialog {
        min-width: 250px;
    }
</style>


<template id="boss-batch">
    <div class="boss-batch" flex="dir:left cross:center">
...
<script>
    Vue.component('boss-batch', {
        ...
        props: {
            ...
            batchLevelUrl: {
                type: String,
                default: 'plugin/boss/mall/boss/batch-level',
            },
            bossLevelList: Array,
        },
        data() {
        ...
        created(){
                 console.log(this.bossLevelList);
