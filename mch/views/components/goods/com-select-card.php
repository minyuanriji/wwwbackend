<style>
    .com-select-card .input-item {
        display: inline-block;
        width: 250px;
    }

    .com-select-card .input-item .el-input__inner {
        border-right: 0;
    }

    .com-select-card .input-item .el-input__inner:hover {
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }

    .com-select-card .input-item .el-input__inner:focus {
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }

    .com-select-card .input-item .el-input-group__append {
    ...
    .com-select-card .input-item .el-input-group__append .el-button {
        padding: 0;
    }
    ...
    .com-select-card .el-dialog__body {
        padding: 10px 20px;
    }

    .com-select-card .card-list {
        margin-top: 20px;
    }

    .com-select-card .card-list .card-list-item {
        margin: 5px 0;
        width: 100%;
    }

    .com-select-card .pagination-box {
        margin-top: 20px;
    }
</style>

<template id="com-select-card">
    <div class="com-select-card">
        <el-dialog
                @close="dialogClose"
                title="选择卡券"
...
<script>
    Vue.component('com-select-card', {
        template: '#com-select-card',
        props: {
            isShow: {
                type: Boolean,
                default: false
