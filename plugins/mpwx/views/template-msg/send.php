            ...
            methods: {
                send() {
                    ...
                    self.selectUsers.forEach(function (item, index) {
                        request({
                            params: {
                                r: 'plugin/mpwx/mall/template-msg/send'
                            },
                            method: 'post',
                            data: {
                                user_id: item.id,
                ...
                getUsers() {
                    ...
                    request({
                        params: {
                            r: 'plugin/mpwx/mall/template-msg/users',
                ...
                addTemplate(formName) {
                    ...
                    self.$refs[formName].validate((valid) => {
                        if (valid) {
                            ...
                            request({
                                params: {
                                    r: 'plugin/mpwx/mall/template-msg/template'
                                },
                                method: 'post',
                                data: {
                ...
                destroyTemplate(index) {
                    ...
                    self.$confirm('删除该条模板, 是否继续?', '提示', {
                        ...
                        request({
                            params: {
                                r: 'plugin/mpwx/mall/template-msg/destroy-template'
                            },
                            method: 'post',
                            data: {
