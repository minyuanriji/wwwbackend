        ...
        <div class="diy-component-preview">
            <div class="diy-topic-normal" flex="dir:left cross:center" v-if="data.style == 'normal'">
                <template v-if="data.count==1">
                    <com-image :src="data.logo_1" mode="scaleToFill"
                               width="104px" height="32px" style="margin-right: 20px;"></com-image>
                </template>
                <template v-else>
                    <com-image :src="data.logo_2" mode="scaleToFill"
                               width="104px" height="50px" style="margin-right: 20px;"></com-image>
                </template>
                <div :style="cStyle">
                    <div flex="dir:left cross:center" v-for="topic in cTopic">
                        <com-image :src="data.icon" mode="scaleToFill"
                                   width="54px" height="28px" style="margin-right: 10px;"></com-image>
                        <div>{{topic.title}}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="topic-list">
                    <template v-for="topic in cTopic">
                        <div class="topic-item" v-if="topic.layout == 0" flex="dir:left box:last">
                            <div flex="dir:top box:last">
                                <div class="topic-title">
                                    <com-ellipsis :line="2">{{topic.title}}</com-ellipsis>
                                </div>
                                <div class="browse">{{topic.read_count}}人浏览</div>
                            </div>
                            <com-image class="topic-pic" :src="topic.cover_pic" width="268px"
                        ...
                        <div class="topic-item" v-else flex="dir:top">
                            ...
                            <com-image class="topic-pic" :src="topic.cover_pic" width="702px"
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="专题样式">
                    <com-radio v-model="data.style" label="normal">简易模式</com-radio>
                    <com-radio v-model="data.style" label="list">列表模式</com-radio>
                </el-form-item>
                <template v-if="data.style == 'normal'">
                    ...
                    <el-form-item label="logo(1行)">
                        ...
                        <com-gallery :url="data.logo_1" :show-delete="true"
                                     @deleted="deletePic('logo_1')"></com-gallery>
                    </el-form-item>
                    <el-form-item label="logo(2行)">
                        ...
                        <com-gallery :url="data.logo_2" :show-delete="true"
                                     @deleted="deletePic('logo_2')"></com-gallery>
                    </el-form-item>
                    <el-form-item label="专题标签">
                        ...
                        <com-gallery :url="data.icon" :show-delete="true"
                                     @deleted="deletePic('icon')"></com-gallery>
                    </el-form-item>
                </template>
                <template v-else>
                    ...
                    <el-form-item label="分类列表" v-if="data.cat_show">
                        <el-card shadow="never" class="topic-edit-options" style="margin-bottom: 24px" v-for="(cat, catIndex) in data.list"
                            ...
                            <div @click="selectCat(catIndex)">
                                ...
                                <div flex="box:first" v-else>
                                    ...
                                    <div>
                                        <com-dialog-select url="mall/topic/index" :multiple="true"
                                                           @selected="selectTopic" :extra-search="{type: cat.cat_id}"
                                                           title="选择专题" list-key="title">
                                            <el-button size="mini">添加专题</el-button>
                                        </com-dialog-select>
                                        <com-gallery :list="cat.children" url-key="cover_pic" :show-delete="true"
                                                     @deleted="deleteTopic" width="100px" height="100px"></com-gallery>
                                    </div>
                                </div>
                            </div>
                        ...
                        <com-dialog-select url="mall/topic-type/index" :multiple="true" @selected="selectCatList"
                                           title="选择分类">
                            <el-button size="mini">添加分类</el-button>
                        </com-dialog-select>
                    </el-form-item>
                    <el-form-item label="专题列表" v-else>
                        <com-dialog-select url="mall/topic/index" :multiple="true" @selected="selectTopic"
                                           title="选择专题" list-key="title">
                            <el-button size="mini">添加专题</el-button>
                        </com-dialog-select>
                        <com-gallery :list="data.topic_list" url-key="cover_pic" :show-delete="true"
                                     @deleted="deleteTopic" width="100px" height="100px"></com-gallery>
                    </el-form-item>
                </template>
            </el-form>
