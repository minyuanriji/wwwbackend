                ...
                <div class="edit-item">
                    ...
                    <div class="body">
                        <el-form-item label="指示器">
                            <com-radio v-model="data.mode" label="rect">条状</com-radio>
                            <com-radio v-model="data.mode" label="round">圆点</com-radio>
                        </el-form-item>
                ...
                <div class="edit-item" style="margin-top: 20px;">
                    ...
                    <div class="body">
                        <el-form-item label="轮播方式">
                            <com-radio v-model="data.autoplay" :label="0">自动播放</com-radio>
                            <com-radio v-model="data.autoplay" :label="1">手动播放</com-radio>
                        </el-form-item>
                        ...
                        <el-form-item label="轮播图静止时间" v-if="data.autoplay === 0">
                            <com-radio v-model="data.interval" :label="1000">1s</com-radio>
                            <com-radio v-model="data.interval" :label="2000">2s</com-radio>
                            <com-radio v-model="data.interval" :label="3000">3s</com-radio>
                            <com-radio v-model="data.interval" :label="4000">4s</com-radio>
                            <com-radio v-model="data.interval" :label="5000">5s</com-radio>
                            <com-radio v-model="data.interval" :label="6000">6s</com-radio>
                            <com-radio v-model="data.interval" :label="7000">7s</com-radio>
                            <com-radio v-model="data.interval" :label="8000">8s</com-radio>
                            <com-radio v-model="data.interval" :label="9000">9s</com-radio>
                            <com-radio v-model="data.interval" :label="10000">10s</com-radio>
                        </el-form-item>
                        <el-form-item label="轮播速度">
                            <com-radio v-model="data.duration" :label="750">标准</com-radio>
                            <com-radio v-model="data.duration" :label="1000">较慢</com-radio>
                            <com-radio v-model="data.duration" :label="500">较快</com-radio>
                        </el-form-item>
                    </div>
                </div>
            </el-form>
            ...
            <el-table v-loading="listLoading" :data="bannerList" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="导航链接">
                    <template slot-scope="scope">
                        <com-ellipsis :line="1">{{scope.row.page_url}}</com-ellipsis>
                    </template>
                </el-table-column>
            </el-table>
