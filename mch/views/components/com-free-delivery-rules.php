...
<div id="com-free-delivery-rules" v-cloak>
        ...
        <div class="table-body">
            <div style="justify-content:space-between;display: flex">
                ...
                <el-button style="float: right; margin: -5px 0; width: 80px; height: 32px;" type="primary" size="small"
                           @click="$navigate({r:'mch/free-delivery-rules/edit'})">添加规则
                </el-button>
            </div>
...
<script>
    Vue.component('com-free-delivery-rules', {
        template: '#com-free-delivery-rules',
        data() {
            return {
                listLoading: false,
                list: [],
        ...
        methods: {
            ...
            loadData(page) {
                ...
                request({
                    params: {
                        r: 'mch/free-delivery-rules/index',
                        page: page,
                    ...
                    if (e.data.code == 0) {
                        ...
                        this.pagination.totalCount=parseInt(this.pagination.totalCount);
                    } else {
            ...
            edit(id) {
                navigateTo({
                    r: 'mch/free-delivery-rules/edit',
                    id: id
                })
            },
            destroy(id){
                this.$confirm('此操作将删除该包邮规则, 是否继续?', '提示', {
                    ...
                    request({
                        params: {
                            r: 'mch/free-delivery-rules/destroy',
                            id: id
                        },
                        method: 'get'
                    }).then(e => {
