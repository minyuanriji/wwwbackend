<style>
    ...
    .com-comment-body .el-button {
        padding: 0!important;
        border: 0;
        margin: 0 5px;
    }

    .com-comment-body .goods-info div{
        height: 50px;
        line-height: 50px;
        white-space: nowrap;
        overflow: hidden;
    ...
    .com-comment-body .input-item {
        display: inline-block;
        width: 250px;
        margin: 0 0 20px;
    }
    
    .com-comment-body .input-item .el-input-group__prepend {
        background-color: #fff;
    }

    .com-comment-body .input-item .el-input__inner {
        border-right: 0;
    }

    .com-comment-body .input-item .el-input__inner:hover{
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }

    .com-comment-body .input-item .el-input__inner:focus{
        border: 1px solid #dcdfe6;
        border-right: 0;
        outline: 0;
    }
    
    .com-comment-body .input-item .el-input-group__append {
        background-color: #fff;
        border-left: 0;
        width: 10%;
        padding: 0;
    ...
    .com-comment-body .input-item .el-input-group__append .el-button {
        padding: 15px;
    }

    .com-comment-body .select {
        float: left;
        width: 100px;
        margin-right: 10px;
    }

    .com-comment-body .open-img .el-dialog {
        margin-top: 0 !important;
    }

    .com-comment-body .click-img {
        width: 100%;
    }
</style>
<template id="com-comment">
                ...
                <el-table-column prop="name" label="商品名称" width="300">
                    <template slot-scope="scope">
                        <div class="goods-info">
                            <com-image mode="aspectFill" style="margin-right: 10px;float: left" :src="scope.row.cover_pic"></com-image>
                            <div>
                    ...
                    <template slot-scope="scope">
                        ...
                        <div>
                            <div v-for="item in scope.row.pic_url" @click="openImg(item)" style="margin: 10px;display: inline-block;cursor: pointer" >
                                <com-image mode="aspectFill" :key="item.id" :src="item"></com-image>
