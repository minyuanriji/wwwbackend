...
use app\forms\common\goods\GoodsCats;
use app\forms\common\goods\GoodsCatsCommon;
use app\logic\ImgMagicLogic;
use app\logic\AppConfigLogic;
use app\models\BaseModel;
use app\models\Option;
use DeepCopy\f001\B;

class HomePageForm extends BaseModel
{
    public function getDetail()
    {
        $option = AppConfigLogic::getHomePageConfig();
    ...
    {
        $imgMagic = ImgMagicLogic::getAll();
        $cats = GoodsCatsCommon::allParentCat();
        $storeBlock = [
            [
                'key' => 'search',
                'name' => '搜索框',
        ...
        $blockList = [];
        if (isset($imgMagic['list']) && is_array($imgMagic['list'])) {
            foreach ($imgMagic['list'] as $item) {
                $blockList[] = [
                    'key' => 'block',
                    'name' => $item['name'],
                    'relation_id' => $item['id'],
