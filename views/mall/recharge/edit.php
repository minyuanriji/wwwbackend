    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="form-body">
            <el-form :model="form" v-loading="loading" label-width="10rem" :rules="FormRules" ref="form">
                ...
                <el-form-item label="" prop="give_money">
                    <template slot='label'>
                        <span>赠送金额</span>
                    ...
                    <el-input size="small" type="number" v-model="form.give_money" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item prop="give_money">
                    <template slot='label'>
                        <span>赠送积分</span>
                    ...
                    <el-input size="small" type="number" v-model="form.give_score" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
        </div>
