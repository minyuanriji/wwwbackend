 ...
 * Time: 17:16
 */
Yii::$app->loadComponentView('share/share-edit');
Yii::$app->loadComponentView('share/com-share-level');
Yii::$app->loadComponentView('share/com-batch');
?>
<style>
    .el-tabs__header {
        font-size: 16px;
...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <div class="batch">
                <com-batch :choose-list="choose_list" :share-level-list="distributionLevelList" @to-search="loadData"></com-batch>
            </div>
                ...
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;"
                    ...
                    <el-table-column label="基本信息" width="200">
                        <template slot-scope="scope">
                            <com-image style="float: left;margin-right: 5px;" mode="aspectFill" :src="scope.row.avatar"></com-image>
                            ...
                            <div v-if="scope.row.status == 1">
                                ...
                                <el-button type="text" size="mini" circle style="margin-left: 10px;margin-top: 10px" @click.native="qrcode(scope.row)">
                                    <el-tooltip class="item" effect="dark" content="查看分销二维码" placement="top">
                                        <img src="statics/img/mall/distribution/qr.png" alt="">
                                    </el-tooltip>
                                </el-button>
    ...
    <el-dialog class="showqr" :visible.sync="showqr" width="20%" center>
        <div style="display: flex;justify-content: center">
            <com-image style="float: left;margin-right: 5px;" mode="aspectFill" :src="avatar" width="50" height="50"></com-image>
            <div>   
    ...
    <com-share-level v-model="level.show" :share="level.share" @success="levelSuccess"></com-share-level>
</div>
<script>
    const app = new Vue({
        el: '#app',
        ...
        methods: {
            ...
            loadData() {
                this.loading = true;
                let params = {
                    r: 'mall/distribution/index-data'
                };
