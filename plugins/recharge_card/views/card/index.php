    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'plugin/recharge_card/admin/card/index',
                        page: self.page,
			...
			generateCard(id){
				request({
				    params: {
				        r: 'plugin/recharge_card/admin/card/generate-card',
				    },
				    data: {card_id:id},
				    method: 'post'
				}).then(e => {
            ...
            batchAction(data) {
                ...
                self.$confirm(data.content, '提示', {
                    ...
                    request({
                        params: {
                            r: 'plugin/recharge_card/admin/card/change-agent-one'
                        },
                        data: data.params,
                        method: 'post'
                    }).then(e => {
            ...
            switchStatus(row) {
                ...
                request({
                    params: {
                        r: 'plugin/recharge_card/admin/profit-level/switch-status',
                    },
                    method: 'post',
                    data: {
                        id: row.id,
            ...
            destroy(row, index) {
                ...
                self.$confirm('删除该经销商, 是否继续?', '提示', {
                    ...
                    request({
                        params: {
                            r: 'plugin/recharge_card/admin/profit-level/destroy',
                        },
                        method: 'post',
                        data: {
                            id: row.id,
