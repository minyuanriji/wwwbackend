    ...
    <el-card shadow="never" style="border:0" class="box-card" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div slot="header">
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'plugin/bsh_app/mall/version/index'})" class="text">版本管理</span>/发布版本</div>
                <div flex="dir:right">
                    <div>
        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="120px">
                ...
                <el-form-item label="APP文件" prop="download_link">
                    ...
                    <el-upload
                            class="upload-demo"
                            action="?r=plugin/bsh_app/mall/version/upload"
            ...
            store(formName) {
                this.$refs[formName].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        request({
                            params: {
                                r: 'plugin/bsh_app/mall/version/edit',
                                id: getQuery('id'),
                            ...
                            if (e.data.code == 0) {
                                ...
                                navigateTo({
                                    r: 'plugin/bsh_app/mall/version/index'
                                })
                            } else {
