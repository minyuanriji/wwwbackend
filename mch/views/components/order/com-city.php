...
<style>
    .com-city .sendForm input::-webkit-outer-spin-button, .com-city .sendForm input::-webkit-inner-spin-button {
        -webkit-appearance: none;
    }

    .com-city .sendForm input[type="number"] {
        -moz-appearance: textfield;
    }
</style>

<template id="com-city">
    <div class="com-city">
        <!-- 配送员选择 -->
        <el-dialog title="选择配送员" :visible.sync="city.dialog" @close="closeDialog" width="35%">
            <el-form v-loading="dialogLoading" label-width="130px" class="sendForm" @submit="prevD">
                ...
                <el-form-item label="配送员" prop="city_name">
                    ...
                    <template v-else>
                        <div>未设置配送员，
                            <el-button type="text" @click="$navigate({r:'mch/delivery/index'}, true)">请前往同城配送设置
                            </el-button>
                        </div>
                    </template>
                </el-form-item>
