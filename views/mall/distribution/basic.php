                                            ...
                                            <el-radio :label="3">
                                                <div style="display: inline-block;">
                                                    <div flex="cross:center">
                                                        ...
                                                        <com-select-cat :show="cat_show" v-model="ruleForm.cat_list"
                    ...
                    <div>
                        <el-row>
                            <el-col :span="14">
                                ...
                                <el-form-item label="提现手续费" prop="cash_service_fee_rate" required>
                                    ...
                                    <el-input type="number" v-model.number="ruleForm.cash_service_fee_rate">
                            ...
                            <el-col :span="14">
                                ...
                                <el-form-item label="待审核页面背景图片" prop="pic_url_status" title="选择图片">
                                    ...
                                    <com-gallery :show-delete="true" @deleted="deleteUrlStatus"
                                                 :url="ruleForm.pic_url_status"></com-gallery>
                                </el-form-item>
                                <el-form-item label="首页背景图片" prop="pic_url_home_head" title="选择图片">
                                    <com-attachment :multiple="false" :max="1" @selected="picUrlHomeHead">
                                        <el-tooltip class="item"
                                                    effect="dark"
                                    ...
                                    <com-gallery :show-delete="true" @deleted="deleteHomeHead"
                                                 :url="ruleForm.pic_url_home_head"></com-gallery>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </div>
