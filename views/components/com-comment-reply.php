...
<style>
    .com-comment-reply .form-body {
        padding: 20px 50% 20px 20px;
        background-color: #fff;
        margin-bottom: 20px;
    }

    .com-comment-reply .form-button {
        margin: 0;
    }

    .com-comment-reply .form-button .el-form-item__content {
        margin-left: 0!important;
    }

    .com-comment-reply .button-item {
        padding: 9px 25px;
    }
</style>
<template id="com-comment-reply">
    <el-card class="com-comment-reply" v-loading="listLoading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="form-body">
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
               ...
               <el-form-item label="详情">
                    <com-image style="display:inline-block" v-for="item in form.pic_url" :key="item.id" mode="aspectFill" :src="item"></com-image>
...
<script>
Vue.component('com-comment-reply', {
    template: '#com-comment-reply',
    props: {
        navigate_url: {
            type: String,
