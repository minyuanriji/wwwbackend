...
<div id="app" v-cloak>
	<el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
	    <div slot="header">
	        <div>
				<el-button :type="pageName=='plan' ? 'primary' : '' "  @click="toOtherPage('mall/finance/integral-plan')">金豆券发放计划</el-button>
				<el-button :type="pageName=='detail' ? 'primary' : '' " @click="toOtherPage('mall/finance/integral-list')">金豆券发放明细</el-button>
				<el-button :type="pageName=='detail' ? 'primary' : '' " @click=" $navigate('mall/finance/integral-list')">金豆券发放明细</el-button>
				<el-button :type="pageName=='dynamic' ? 'primary' : '' ">限时金豆券</el-button>
	        </div>
	    </div>
	</el-card>
