                    ...
                    <div v-show="active == 2">
                        ...
                        <el-form-item label="上传证件信息" prop="info">
                            <div style="float: left">
                                <div class="id-card">
                                    <com-attachment v-model="ruleForm.id_card_front_pic" :simple="true">
                                ...
                                <div class="id-card">
                                    <com-attachment v-model="ruleForm.id_card_back_pic" :simple="true">
                                        <div class="card-upload">
                            ...
                            <div class="business">
                                <com-attachment v-model="ruleForm.business_pic" :simple="true">
                                    <div class="card-upload">
