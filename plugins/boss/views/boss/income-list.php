        ...
        <div class="table-body">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;">
                    ...
                    <el-table-column label="股东" width="200">
                        <template slot-scope="scope">
                            <div>股东等级：{{scope.row.boss_level_name}}</div>
                            <div>提成类型：{{scope.row.price_type}}</div>
                        </template>
                    </el-table-column>
                    <el-table-column label="结算金额" prop="goods_price" width="200"></el-table-column>
                    <el-table-column label="提成比例（%）" prop="price" width="200"></el-table-column>
                    <el-table-column label="结算佣金" prop="commission" width="150"></el-table-column>
                    <el-table-column label="订单状态" prop="order_status" width="150"></el-table-column>

<!--                    <el-table-column label="操作" width="200">-->
<!--                        <template slot-scope="scope">-->
<!--                            <div><span @click="$navigate({r:'plugin/boss/mall/boss/income-detail'})"-->
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            loadData() {
                this.loading = true;
                let params = {
                    r: 'plugin/boss/mall/boss/income-list'
                };
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        ...
                        this.boss_level_list = e.data.data.boss_level_list;
                    } else {
