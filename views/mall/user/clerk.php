            ...
            <el-table :data="form" border style="width: 100%">
                ...
                <el-table-column prop="nickname" label="用户" width="180">
                    <template slot-scope="scope">
                        <div flex="dir:left">
                            <div>
                                <com-image mode="aspectFill" width="47" height="47" :src="scope.row.user.userInfo.avatar"></com-image>
                            </div>
                            <div flex="dir:top" class="user-info-box">
                                ...
                                <com-ellipsis style="width: 120px;" :line="1">{{scope.row.user.nickname}}</com-ellipsis>
                            </div>
                        </div>
                    </template>
                </el-table-column>
