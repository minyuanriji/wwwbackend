                                ...
                                <template v-for="(item, index) in attachments">
                                    <el-tooltip class="item" effect="dark" :content="item.name" placement="top"
                                        ...
                                        <div
                                            ...
                                            <img v-if="item.type == 'image'" class="com-attachment-img"
                                                 :src="item.thumb_url"
                                                 style="width: 100px;height: 100px;">
                                            <div v-if="item.type == 'video'" class="com-attachment-img"
                                                ...
                                                <video style="width: 0;height: 0;visibility: hidden;"
                                                    ...
                                                    <source :src="item.thumb_url">
                                                </video>
                                                <div class="com-attachment-video-info">
                                                    <i class="el-icon-video-play"></i>
                                                    <span>{{item.duration?item.duration:'--:--'}}</span>
                                                </div>
                                            </div>
                                            <div v-if="item.type == 'doc'" class="com-attachment-img"
                                                 style="width: 100px;height: 100px;line-height: 100px;text-align: center">
                                                <i class="file-type-icon el-icon-document"></i>
                                            </div>
                                            <div class="com-attachment-name">{{item.name}}</div>
        ...
        methods: {
            ...
            deleteItems() {
                ...
                this.$confirm('确认删除所选的' + itemIds.length + '张图片？', '提示', {
                    ...
                    this.$request({
                        params: {
                            r: 'mch/common/attachment/delete'
                        },
                        method: 'post',
                        data: {
                            ids: itemIds,
            ...
            loadGroups() {
                ...
                this.$request({
                    params: {
                        r: 'mch/common/attachment/group-list',
                        is_recycle: 0,
                        type: this.type,
                    },
                }).then(e => {
            ...
            deleteGroup(index) {
                ...
                this.$confirm(title, '提示', {
                    ...
                    this.$request({
                        params: {
                            r: 'mch/common/attachment/group-delete',
                        },
                        method: 'POST',
                        data: {
            ...
            groupFormSubmit(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$request({
                            params: {
                                r: 'mch/common/attachment/group-update',
                            },
                            method: 'post',
            ...
            loadList(params) {
                ...
                params['r'] = 'mch/common/attachment/list';
