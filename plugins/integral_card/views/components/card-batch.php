                        ...
                        <template>
                            ...
                            <el-form-item v-if="currentBatch == 'have'" v-loading="isHavaList">
                                <el-radio-group v-model="batch_card_id" size="small" @change="toggleRadio">
                                  <el-radio border v-for="(item, index) in havaList" :label="item.id" >{{item.name}} - {{item.user?item.user.nickname:'不存在'}}</el-radio>
...
<script>
    Vue.component('card-batch', {
        ...
        props: {
            ...
            batchChangeAgentUrl: {
                type: String,
                default: 'plugin/integral_card/admin/card/change-agent',
            },
        ...
        methods: {
            ...
            searchCart() {
                ...
                request({
                    params: {
                        r: 'plugin/integral_card/admin/card/find-card',
                    },
