...
Yii::$app->loadPluginComponentView('team-edit');
?>
...
<div id="app" v-cloak>
    <el-card shadow="never" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table
                ...
                <el-table-column prop="price" label="佣金" width="200">
                </el-table-column>
                <el-table-column
                        label="启用状态"
                        width="120">
    ...
    <team-edit v-model="edit.show" :row="edit.row" @success="success"></team-edit>
</div>
<script>
    const app = new Vue({
        el: '#app',
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'plugin/distribution/mall/level/team',
                        page: self.page,
            ...
            levelDelete(row, index) {
                ...
                self.$confirm('删除该配置, 是否继续?', '提示', {
                    ...
                    request({
                        params: {
                            r: 'plugin/distribution/mall/level/team-delete',
                        },
                        method: 'post',
                        data: {
                            id: row.id,
