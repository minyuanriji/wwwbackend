            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column width='150' prop="sub_price" label="优惠方式">
                    <template slot-scope="scope">
                        ...
                        <div v-if="scope.row.discount_limit">优惠上限:{{scope.row.discount_limit}}</div>
                    </template>
                </el-table-column>
                ...
                <el-table-column width='180' prop="expire_type" label="有效时间">
                    <template slot-scope="scope">
                        ...
                        {{scope.row.begin_at|dateTimeFormat('Y-m-d H:i:s')}}至{{scope.row.end_at|dateTimeFormat('Y-m-d H:i:s')}}
                    </span>
                    </template>
                </el-table-column>
                ...
                <el-table-column width='180' prop="is_failure" label="是否过期">
                    <template slot-scope="scope">
                        <span v-if="scope.row.is_failure == 1">
                            已过期
                        </span>
                        <span v-else-if="scope.row.is_failure == 0">
                            未过期
                        </span>
                    </template>
                </el-table-column>
