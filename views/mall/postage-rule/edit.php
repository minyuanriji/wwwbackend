    ...
    <el-card shadow="never" style="border:0" v-loading="listLoading" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'mall/setting/rule'})">运费规则</span></el-breadcrumb-item>
        ...
        <div style="margin-bottom: 1rem;">
            <el-form :model="detail" ref="detail" label-width="100px" :rules="detailRules">
                ...
                <el-form-item prop="list" label="地区选择">
                    <com-district :detail="ruleForm.detail" :edit="detail.list" @selected="selectDistrict" :level="3"></com-district>
                </el-form-item>
