...
<div id="app" v-cloak>
    ...
    <com-dialog-select title="选择商城" url="mall/model/get-mall" @selected="confirm" :display="display1" @close="close">
    </com-dialog-select>
    <com-dialog-select title="选择模板" url="mall/model/get-template" :params="params" @selected="confirm" @close="close"
                       :display="display2">
    </com-dialog-select>
