                        ...
                        <div class="check-head"
                            ...
                            <div flex="dir:left box:last" style="padding-top: 30px;padding-left:10px">
                                <div flex="dir-left">
                                    ...
                                    <com-image width="30px" height="15px" :src="defaultRemind"></com-image>
                                </div>
                                <div flex="dir:top">
                            ...
                            <div :style="{'color': form.daily_font ? form.daily_font : '#FFFFFF'}"
                                 v-if="signInStatus == 2" @click="enter(1)" flex="dir:top cross:center"
                                 style="margin-top:-60px">
                                <com-image height="100px" width="100px" style="border-radius:50%"
                                           :src="form.not_signed_icon ? form.not_signed_icon : defaultSignInOff"></com-image>
                            ...
                            <div :style="{'color': form.daily_font ? form.daily_font : '#FFFFFF'}"
                                 v-if="signInStatus == 1" @click="enter(2)" flex="dir:top cross:center"
                                 style="margin-top:-60px">
                                <com-image height="100px" width="100px" style="border-radius:50%"
                                           :src="form.signed_icon ? form.signed_icon : defaultSignInOn"></com-image>
                                <div>今日还未签到</div>
                                <div>已连续签到11天</div>
                            </div>
                        </div>
                        <div flex="dir:top" :style="{
                            ...
                            <div flex="dir:top"
                                ...
                                <div class="line"
                                    ...
                                    <com-image height="30px" width="30px"
                                               :src="form.integral_icon ? form.integral_icon : defaultRed"></com-image>
                            ...
                            <div flex="dir:top cross:center"
                                ...
                                <com-image height="305px" width="351px" :src="defaultCalendar" style="z-index: 99"></com-image>
                                <com-image style="position:absolute;top:147px;left:246px;height:30px;width:30px"
                                           :src="form.calendar_icon ? form.calendar_icon : defaultChooser"></com-image>
                                <com-image style="position:absolute;top:147px;left:292px;height:30px;width:30px"
                                           :src="form.calendar_icon ? form.calendar_icon : defaultChooser"></com-image>
                            </div>
                        </div>
                    </div>
                    ...
                    <el-row>
                        ...
                        <el-col :span="14">
                            <el-form-item label="未签到图标" prop="not_signed_icon">
                                <com-attachment :multiple="false" :max="1" @selected="notSignedPhoto">
                                    <el-tooltip class="item" effect="dark" content="建议尺寸:260*260" placement="top">
                                        <el-button size="mini">选择文件</el-button>
                                    </el-tooltip>
                                </com-attachment>
                                <com-image v-if="form.not_signed_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.not_signed_icon"></com-image>
                            </el-form-item>
                            <el-form-item label="已签到图标" prop="signed_icon">
                                <com-attachment :multiple="false" :max="1" @selected="signedPhoto">
                                    <el-tooltip class="item" effect="dark" content="建议尺寸:260*260" placement="top">
                                        <el-button size="mini">选择文件</el-button>
                                    </el-tooltip>
                                </com-attachment>
                                <com-image v-if="form.signed_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.signed_icon"></com-image>
                            </el-form-item>
                            <el-form-item label="头部背景图" prop="head_bg">
                                <com-attachment :multiple="false" :max="1" @selected="headBgPhoto">
                            ...
                            <el-form-item label="红包图标" prop="balance_icon">
                                ...
                                <com-image v-if="form.balance_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.balance_icon"></com-image>
                            </el-form-item>
                            <el-form-item label="积分图标" prop="integral_icon">
                                <com-attachment :multiple="false" :max="1" @selected="integralPhoto">
                                    <el-tooltip class="item" effect="dark" content="建议尺寸:72*72" placement="top">
                                        <el-button size="mini">选择文件</el-button>
                                    </el-tooltip>
                                </com-attachment>
                                <com-image v-if="form.integral_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.integral_icon"></com-image>
                            </el-form-item>
                            <el-form-item label="日历签到图标" prop="calendar_icon">
                                <com-attachment :multiple="false" :max="1" @selected="calendarPhoto">
                                    <el-tooltip class="item" effect="dark" content="建议尺寸:64*64" placement="top">
                                        <el-button size="mini">选择文件</el-button>
                                    </el-tooltip>
                                </com-attachment>
                                <com-image v-if="form.calendar_icon" mode="aspectFill" width='80px' height='80px'
                                           :src="form.calendar_icon"></com-image>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                defaultSignInOn: "<?= \app\helpers\PluginHelper::getPluginBaseAssetsUrl() ?>" + '/img/check-in.png',
                defaultSignInOff: "<?= \app\helpers\PluginHelper::getPluginBaseAssetsUrl() ?>" + '/img/over.png',
            ...
            onSubmit() {
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        request({
                            params: {
                                r: 'plugin/sign_in/mall/index/customize',
                            },
                            data: para,
                            method: 'post'
                        }).then(e => {
