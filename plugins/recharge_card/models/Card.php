...
class Card extends BaseActiveRecord{
    ...
    public static function generateCard($card_id){
        ...
        try{
            ...
            $path = "/h5/#/pages/user/shopping/rechargeCard?mall_id=".$card_info['mall_id']."&source=".User::SOURCE_SHARE_POSTER;
            //$path = "/h5/#/pages/user/shopping/rechargeCard?mall_id=".$card_info['mall_id']."&pid=".$card_info['user_id']."&source=".User::SOURCE_SHARE_POSTER;
            $url = $host . $path;
