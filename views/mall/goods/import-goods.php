...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <com-add-cat ref="cats" :new-cats="ruleForm.cat_ids" @select="selectCat" :mch_id="mch_id"></com-add-cat>
            <com-add-cat ref="systemCats" :new-cats="ruleForm.system_cat_ids" @select="selectSystemCat"></com-add-cat>
        </div>
    </el-card>
</div>
<script>
