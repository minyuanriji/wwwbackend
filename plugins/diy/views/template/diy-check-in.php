        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="背景图">
                    <com-image-upload v-model="data.backgroundPicUrl" width="750" height="200"></com-image-upload>
                </el-form-item>
                <el-form-item label="点击热区">
                    <com-hotspot :pic-url="data.backgroundPicUrl"
                ...
                <el-form-item label="文字位置">
                    <com-radio v-model="data.textPosition" label="left">靠左</com-radio>
                    <com-radio v-model="data.textPosition" label="center">居中</com-radio>
                    <com-radio v-model="data.textPosition" label="right">靠右</com-radio>
                </el-form-item>
