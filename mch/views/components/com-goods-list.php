...
echo $this->render('/components/goods/com-search');
echo $this->render('/components/goods/com-batch');
?>
...
<!--                                <el-button @click="download" v-if="exportParams.percentage == 100" size="small"-->
            ...
            <div class="table-body">
                ...
                <el-table
                    ...
                    <el-table-column label="线下核销" width="110">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="100" label="申请状态">
                        <template slot-scope="scope">
                            <template>
...
<script>
    Vue.component('com-goods-list', {
        ...
        props: {
            ...
            destroy_goods_url: {
                type: String,
                default: 'mch/goods/delete'
            },
            edit_goods_sort_url: {
                type: String,
                default: 'mch/goods/edit-sort'
            },
            edit_goods_status_url: {
                type: String,
                default: 'mch/goods/switch-status'
            },
        ...
        data() {
            return {
                ...
                exportParams: {
                    ...
                    is_download: 0,
                    percentage: 0,
                    action_url: '<?= Yii::$app->urlManager->createUrl('mch/goods/export-goods-list') ?>',
                    goods_count: 0,//商品总数
                }
            };
        },
