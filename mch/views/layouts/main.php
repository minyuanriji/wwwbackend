...
<?php $this->beginPage(); ?>
    ...
    <head>
        ...
        <title><?= Yii::$app->mchAdmin->identity->mchModel->store->name;?>-商城管理</title>
        <link rel="stylesheet"
    ...
    <?php $this->beginBody() ?>
    <div id="_layout"></div>
    <?= $this->renderFile('@app/mch/views/components/index.php') ?>
    <div class="el-container">
        ...
        <div id="_layout_body" class="el-container is-vertical">
            <?php Yii::$app->loadComponentView('header', __DIR__); ?>
            <div id="_header">
    ...
    <script>
        ...
        _aside = new Vue({
            ...
            methods: {
                ...
                indexClick() {
                    navigateTo({r: '/mch/overview/index'})
                    this.clearMenuStorage();
                },
                clearMenuStorage() {
            ...
            mounted: function () {
                this.getMenus();
                if(getQuery('r') == 'mch/overview/index'){
