            ...
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <span style="color: #409EFF;cursor: pointer"
                          @click="$navigate({r:'mall/area/level'})">
                        经销商等级
                    </span>
                </el-breadcrumb-item>
            ...
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                <el-row>
                    <el-col :span="24">
                        ...
                        <el-form-item label="团队奖佣金类型" prop="area_price_type" required>
                            <el-radio-group v-model="ruleForm.area_price_type">
                                <el-radio :label="0">百分比</el-radio>
                                <el-radio :label="1">固定金额</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="团队奖励">
                            <el-input v-model.number="ruleForm.area_price" type="number">
                                <template slot="append" v-if="ruleForm.area_price_type == 0">%</template>
                                <template slot="append" v-if="ruleForm.area_price_type == 1">元</template>
                            </el-input>
                        </el-form-item>
                        <el-form-item label="被越级的奖励">
                            <el-input v-model.number="ruleForm.over_area_price" type="number">
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    name: [
                        {required: true, message: '请输入经销商等级名称', trigger: 'change'},
                    ],
                    is_use: [
                        {required: true, message: '请选择经销商等级状态', trigger: 'change'},
                    ],
                    detail: [
        ...
        methods: {
            ...
            getSetting() {
                ...
                request({
                    params: {
                        r: 'plugin/area/mall/level/setting',
                    },
                    method: 'get',
                }).then(res => {
                    this.cardLoading = false;
