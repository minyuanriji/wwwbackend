...
class Option extends BaseActiveRecord
{
    ...
    const NAME_APP_SHARE_SETTING = 'app_distribution_setting'; // 自定义分享
    ...
    const NAME_REFUND_REASON = 'refund_reason';//商品导入错误数据
    const NAME_REGISTER_AGREE = 'register_agree';//注册协议
