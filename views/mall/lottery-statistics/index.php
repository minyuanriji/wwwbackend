...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <com-header :url="url" :new-search="JSON.stringify(search)">幸运抽奖</com-header>
        </div>
            ...
            <el-table @sort-change="changeSort" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '10px 0',fontWeight: '400'}" :data="list">
                <el-table-column prop="name" width="500" label="商品名称">
                    <template slot-scope="scope">
                        <com-image style="margin-right: 10px;float: left;" :src="scope.row.cover_pic" width="32px" height="32px">
                        </com-image>
                ...
                <el-table-column prop="seckill_time" width="180" label="活动时间">
                    <template slot-scope="scope">
