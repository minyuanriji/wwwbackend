...
<!--                        <el-button type="primary" size="small" @click="issue">发布</el-button>-->
    ...
    <com-dialog-select title="选择商城" url="plugin/diy/mall/market/get-mall" @selected="confirm" :display="display1" @close="close">
    </com-dialog-select>
    <com-dialog-select title="选择模板" url="plugin/diy/mall/market/get-template" :params="params" @selected="confirm" @close="close"
                       :display="display2">
    </com-dialog-select>
