...
<?php Yii::$app->loadComponentView('com-rich-text') ?>
<style>
    .form-body {
        padding: 20px 0;
    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header" class="clearfix">
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'mall/article/index'})" class="text">文章</span>/文章编辑</div>
                <div flex="dir:right">
                    <div>
        ...
        <div class="form-body">
            <el-form :model="form" label-width="100px" :rules="FormRules" ref="form">
                ...
                <el-form-item label="内容" prop="discount">
                    <com-rich-text v-model="form.content"></com-rich-text>
                </el-form-item>
            </el-form>
        </div>
    </el-card>
