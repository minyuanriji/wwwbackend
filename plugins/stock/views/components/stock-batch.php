<style>
    ...
    .stock-batch .batch-box {
        margin-left: 10px;
    }

    .stock-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .stock-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .stock-batch .batch-title {
        font-size: 18px;
    }

    .stock-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .stock-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .stock-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .stock-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .stock-batch .batch-box-right {
        padding: 5px 20px;
    }

    .stock-batch .express-dialog .el-dialog {
        min-width: 250px;
    }
</style>


<template id="stock-batch">
    <div class="stock-batch" flex="dir:left cross:center">
...
<script>
    Vue.component('stock-batch', {
        template: '#stock-batch',
        props: {
            // 列表选中的数据
            chooseList: {
                type: Array,
            ...
            batchLevelUrl: {
                type: String,
                default: 'plugin/stock/mall/stock/batch-level',
            },
            agentLevelList: Array,
        },
        data() {
            return {
                isAllChecked: false,
        ...
        created(){
                 console.log(this.agentLevelList);
