    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->gmtPay = $arrayResult['gmtPay'];
    			}
    		    	    			    		    			if (array_key_exists ( "gmtEnd", $this->arrayResult )) {
    			$this->gmtEnd = $arrayResult['gmtEnd'];
    			}
    			...
    			$this->activeStatus = $arrayResult['activeStatus'];
    			}
    			...
    			$this->paidFee = $arrayResult['paidFee'];
    			}
    		    	    			    		    			if (array_key_exists ( "goodsFee", $this->arrayResult )) {
    			$this->goodsFee = $arrayResult['goodsFee'];
    			}
    			...
    			$this->paidPostFee = $arrayResult['paidPostFee'];
    			}
    		    	    		}
