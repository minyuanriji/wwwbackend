            ...
            <el-form @submit.native.prevent label-width="150px">
                <template>
                    ...
                    <el-form-item v-if="data.showCoupon" label="优惠券背景图片">
                        <com-image-upload width="320" height="164" v-model="data.couponPicUrl"></com-image-upload>
                    </el-form-item>
                </template>
                <template>
                    <hr>
                    ...
                    <el-form-item v-if="data.showGoods" label="单品样式">
                    ...
                    <el-form-item label="商品角标样式" v-if="data.showGoodsTag">
                        <el-radio v-model="data.goodsTagPicUrl" v-for="tag in goodsTags" :label="tag.picUrl"
                                  :key="tag.name"
