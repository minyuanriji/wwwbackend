        ...
        <div class="table-body">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;">
                    ...
                    <el-table-column label="区域代理" width="400">
                        <template slot-scope="scope">
                            <div>区域代理等级：{{scope.row.area_level_name}}</div>
                        </template>
                    </el-table-column>
                  ...
                  <!--  <el-table-column label="操作" width="200">
                        <template slot-scope="scope">
                            <div><span @click="$navigate({r:'plugin/area/mall/area/income-detail'})"
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            loadData() {
                this.loading = true;
                let params = {
                    r: 'plugin/area/mall/area/income-list'
                };
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        ...
                        this.area_level_list = e.data.data.area_level_list;
                    } else {
