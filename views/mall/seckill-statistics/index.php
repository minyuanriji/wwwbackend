...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <com-header :url="url" :new-search="JSON.stringify(search)">整点秒杀</com-header>
        </div>
        ...
        <div class="table-body" style="padding: 20px">
            ...
            <el-table v-loading="loading" @sort-change="changeSort"
                ...
                <el-table-column prop="user_num" label="支付人数" :label-class-name="prop == 'user_num' ? 'sort-active': ''"
                                 sortable='custom'>
                </el-table-column>
                <el-table-column prop="goods_num" label="支付件数"
                                 :label-class-name="prop == 'goods_num' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
                <el-table-column prop="pay_price" label="支付金额"
                                 :label-class-name="prop == 'pay_price' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'mall/seckill-statistics/index',
                        page: this.page,
