                                        ...
                                        <div :style="cGoodsItemInfoStyle">
                                            ...
                                            <div flex="box:last cross:bottom">
                                                ...
                                                <div class="goods-level-price">
                                                    <template v-if="data.showGoodsLevelPrice">￥{{goods.level_price}}</template>
                                                    <span v-if="data.isUnderLinePrice && [-1,1,2].indexOf(data.listStyle) != -1"
                                                          :style="{display: data.listStyle == -1 ? 'inline' : 'block'}"
                                                          class="goods-underline-price">
                                                        ￥{{goods.price}}
            ...
            <el-form label-width='150px' @submit.native.prevent>
                ...
                <template v-if="data.showCat">
                    <el-form-item label="分类栏位置">
                        <com-radio v-model="data.catPosition" label="top" @change="catPositionChange">顶部</com-radio>
                        <com-radio v-model="data.catPosition" label="left" @change="catPositionChange">左侧</com-radio>
                        <div style="color: #909399;line-height: normal;">只有一个分类时顶部不会显示分类栏</div>
                    </el-form-item>
                    <el-form-item label="分类样式" v-if="data.catPosition==='top'">
                        <com-radio v-model="data.catStyle" :label="1">样式1</com-radio>
                        <com-radio v-model="data.catStyle" :label="2">样式2</com-radio>
                    </el-form-item>
                ...
                <template v-else>
                    <el-form-item label="商品添加">
                        <com-radio v-model="data.addGoodsType" :label="0">自动添加</com-radio>
                        <com-radio v-model="data.addGoodsType" :label="1">手动添加</com-radio>
                    </el-form-item>
                ...
                <el-form-item label="列表样式" v-if="data.catPosition==='top'">
                    ...
                    <com-radio v-model="data.listStyle" :label="0" @change="listStyleChange">左右滑动</com-radio>
                    ...
                    <com-radio v-model="data.listStyle" :label="3" @change="listStyleChange">一行三个</com-radio>
                </el-form-item>
                ...
                <el-form-item label="购买按钮样式"
                    ...
                    <com-radio v-model="data.buyBtn" label="cart">购物车</com-radio>
                    <com-radio v-model="data.buyBtn" label="add">加号</com-radio>
                    <com-radio v-if="data.listStyle!=3"
