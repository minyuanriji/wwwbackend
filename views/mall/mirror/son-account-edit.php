...
<div id="app" v-cloak>
    <el-card v-loading="cardLoading" class="box-card">
        ...
        <div class="form">
            <el-form ref="form" label-position="left" :model="form" :rules="rules" label-width="120px" size="small">
                ...
                <el-form-item label="小程序数量" prop="mall_num" ref="mall_num">
                    <el-input :disabled="isAppMaxCount" type="number" class="common-width"
                              v-model="form.mall_num">
                    </el-input>
                ...
                <el-form-item label="账户有效期" prop="expired_at" ref="expired_at">
    ...
    <com-dialog-template :show="show" @selected="templateSelected" :status="1"
                         :selected="templateList"></com-dialog-template>
    <com-dialog-template :show="show_use" @selected="useTemplateSelected" :status="0"
                         :selected="useTemplateList"></com-dialog-template>
</div>
<script>
    const app = new Vue({
        el: '#app',
        ...
        methods: {
            ...
            getDetail() {
                ...
                request({
                    ...
                    if (e.data.code === 0) {
                        ...
                        if (self.form.expired_at == "0") {
                            self.isCheckExpired = true;
                            self.isExpiredDisabled = true;
                            self.form.adminInfo.expired_at = 0;
                        }
                        if (self.form.mall_num == -1) {
            ...
            checkExpiredAt(value) {
                ...
                if (value) {
                    this.form.adminInfo.expired_at = 0;
                } else {
            ...
            appMaxCount(value) {
                ...
                if (value) {
                    this.form.adminInfo.mall_num = -1;
                } else {
                    this.form.adminInfo.mall_num = '';
                }
                this.$refs['mall_num'].clearValidate();
            },
            // 权限全选事件
