...
class PhoneOrderPayForm extends BaseModel
{
    ...
    {
        return [
            [['order_no', 'order_price', 'qyj_order_num'], 'required']
        ];
    }
    ...
    public function pay()
    {
        ...
        try {
            ...
            $submit_res = $plate_form->submit($this->qyj_order_num, $plateform);
            ...
            $addcredit_order->pay_request_data = $submit_res->request_data;
            $addcredit_order->pay_response_data = $submit_res->response_content;
