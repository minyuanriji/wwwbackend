 ...
 */
class OrderDetailExpress extends BaseActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function getNewestOrderDetailExpress($order_id){
        return OrderDetailExpress::find()->where(['order_id' => $order_id])
