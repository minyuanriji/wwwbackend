...
<style>
    ...
    .com-hotspot .el-input {
        width: 70px;
    }

    .com-hotspot .right label {
        padding: 0 10px;
    }
    ...
    .com-hotspot .pic-list {
        position: relative;
    }

    .com-hotspot .pic-list div {
        position: absolute;
        left: 0;
        top: 0;
    }
    ...
    .com-hotspot .el-input-group__append {
        background-color: #fff;
    }
</style>
<template id="com-hotspot">
    <div class="com-hotspot">
...
<script>
    Vue.component('com-hotspot', {
        template: '#com-hotspot',
        props: {
            multiple: Boolean,
            picUrl: String,
            width: {
