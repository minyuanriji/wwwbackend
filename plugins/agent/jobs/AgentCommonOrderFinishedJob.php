...
use app\forms\common\agent\AgentCommon;
...
class AgentCommonOrderFinishedJob extends Component implements JobInterface
{
    ...
    public function execute($queue)
    {
        ...
        try{
            ...
            $agentLevel = AgentSetting::getValueByKey(AgentSetting::LEVEL, $common_order->mall_id);
            if ($agentLevel) {
