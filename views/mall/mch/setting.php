<?php
Yii::$app->loadComponentView('com-setting');
?>
<style>
    .red {
        color: #ff4544;
...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <el-form v-if="is_show" class="form-body" ref="form" :model="form" :rules="rule" label-width="160px" size="small">
            <el-row>
                <el-col :span="24">
                    <com-setting v-model="form" :is_distribution="mchMallSetting.is_distribution == 1" :is_payment="false" :is_surpport_city="false"></com-setting>
                    ...
                    <el-form-item v-if="form.is_web_service == '1'">
                        <com-attachment :multiple="false" :max="1" v-model="form.web_service_pic">
                        ...
                        <com-image style="width: 80px; height: 80px;"
                                   :src="form.web_service_pic"></com-image>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
