...
<div id="app" v-cloak>
    <el-card shadow="never">
        ...
        <el-form size="small" :inline="true" :model="search">
            <el-form-item label="KEY密钥文件" prop="wechat_key_path">
                <el-input placeholder="未提交任何文件">
                ...
                <template slot-scope="scope">
                    <div flex="box:first">
                        <div style="padding-right: 10px">
                            <com-image mode="aspectFill" :src="scope.row.pic"></com-image>
                        </div>
                        <div>
                            <com-ellipsis :line="2">{{scope.row.data1}}</com-ellipsis>
                            <com-ellipsis :line="1">{{scope.row.data2}}</com-ellipsis>
                        </div>
                    </div>
                </template>
            </el-table-column>
    ...
    <el-card>
        <div slot="header">
            ...
            <el-dialog title="选择地区" :visible.sync="dialogVisible" width="50%">
                <com-district :detail="detail" @selected="selectDistrict" :level="3"
                              :edit="editDistrict"></com-district>
