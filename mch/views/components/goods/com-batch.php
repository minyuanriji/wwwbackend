...
<style>
    ...
    .com-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .com-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .com-batch .batch-title {
        font-size: 18px;
    }

    .com-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .com-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .com-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .com-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .com-batch .batch-box-right {
        padding: 5px 20px;
    }

    .com-batch .express-dialog .el-dialog {
        min-width: 250px;
    }

    .com-batch .add-express-rule {
        margin-left: 20px;
        cursor: pointer;
        color: #419EFB;
    }

    .com-batch .confine-box .label {
        margin-right: 10px;
    }

    .com-batch .goods-price .el-input-group__prepend {
        width: 80px;
    }
</style>


<template id="com-batch">
    <div class="com-batch" flex="dir:left cross:center">
                        ...
                        <div v-if="currentBatch === 'express-price'">
                            <el-form-item label="运费设置">
                                <div style="display: inline-block">
                                    ...
                                    <span @click="$navigate({r:'mch/postage-rules/index'}, true)"
                                ...
                                <div flex="dir:left">
                                    ...
                                    <div style="margin-left: 5px;width: 100%;">
                                        <el-input type="number"
                                                  ...
                                                  v-model="integral.give_score">
                                            <template slot="append">
                                                分
                                                <el-radio v-model="integral.give_score_type" :label="1">固定值
                                                </el-radio>
                                                <el-radio v-model="integral.give_score_type" :label="2">百分比
                                                </el-radio>
                                            </template>
                                        </el-input>
                                    </div>
                                ...
                                <div flex="dir:left">
                                    ...
                                    <div style="margin-left: 5px;width: 100%;">
                                        <el-input type="number"
                                                  ...
                                                  oninput="this.value = this.value.replace(/[^0-9]/, '');"
                                                  min="0"
                                                  v-model="integral.forehead_score">
                                            <template slot="prepend">最多抵扣</template>
                                            <template slot="append">
                                                元
                                                <el-radio v-model="integral.forehead_score_type" :label="1">固定值
                                                </el-radio>
                                                <el-radio v-model="integral.forehead_score_type" :label="2">百分比
                                                </el-radio>
                                            </template>
                                        </el-input>
                                        <el-checkbox
    ...
    Vue.component('com-batch', {
        ...
        props: {
            ...
            batchUpdateStatusUrl: {
                type: String,
                default: 'mch/goods/batch-update-status',
            },
            batchDestroyUrl: {
                type: String,
                default: 'mch/goods/batch-destroy',
            },
            batchConfineUrl: {
                type: String,
                default: 'mch/goods/batch-update-confine-count',
            },
            batchFreightUrl: {
                type: String,
                default: 'mch/goods/batch-update-freight',
            },
            // 上架弹框提示文字
            statusChangeText: {
                type: String,
            ...
            dialogSubmit() {
                ...
                switch (this.currentBatch) {
                    ...
                    case 'integral':
                        ...
                        params.give_score_type = this.integral.give_score_type;
                        params.give_score = this.integral.give_score;
                        params.forehead_score = this.integral.forehead_score;
                        params.forehead_score_type = this.integral.forehead_score_type;
                        params.accumulative = this.integral.accumulative;
                        this.batchAction({
                            url: 'mch/goods/batch-update-integral',
                            content: text,
                            params: params
                        });
                        break;
                    ...
                    case 'goods-price':
                        ...
                        this.batchAction({
                            url: 'mch/goods/batch-update-goods-price',
