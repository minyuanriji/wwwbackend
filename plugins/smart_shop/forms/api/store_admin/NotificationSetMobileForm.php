...
class NotificationSetMobileForm extends BaseModel{
    ...
    public function rules(){
        return [
            [['merchant_id', 'store_id', 'mobile'], 'required'],
            [['mobile'], 'trim']
        ];
    }
    ...
    public function set(){
        ...
        try {
            ...
            if(!CommonHelper::isMobile($this->mobile)){
            ...
            $notification->data_json  = json_encode(["mobile" => $this->mobile]);
