<style>
    ...
    .distribution-batch .batch-box {
        margin-left: 10px;
    }

    .distribution-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .distribution-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .distribution-batch .batch-title {
        font-size: 18px;
    }

    .distribution-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .distribution-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .distribution-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .distribution-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .distribution-batch .batch-box-right {
        padding: 5px 20px;
    }

    .distribution-batch .express-dialog .el-dialog {
        min-width: 250px;
    }
</style>


<template id="distribution-batch">
    <div class="distribution-batch" flex="dir:left cross:center">
...
<script>
    Vue.component('distribution-batch', {
        template: '#distribution-batch',
        props: {
            // 列表选中的数据
            chooseList: {
                type: Array,
            ...
            batchLevelUrl: {
                type: String,
                default: 'plugin/distribution/mall/distribution/batch-level',
            },
        ...
        created(){
                 console.log(this.distributionLevelList);
