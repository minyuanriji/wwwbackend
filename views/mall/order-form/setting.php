    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div slot="header">
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'mall/order-form/list'})" class="text">表单列表</span>/表单设置</div>
                <div flex="dir:right">
                    <div>
        ...
        <el-form :model="ruleForm" @submit.native.prevent :rules="rules" size="small" ref="ruleForm"
                 label-width="120px">
            <div class="form-body">
                <el-row>
                    <el-col :span="24">
                        ...
                        <template v-if="ruleForm.status == 1">
                            ...
                            <el-form-item label="表单设置" prop="selectedOptions">
                                <com-form :value.sync="ruleForm.value"></com-form>
                            </el-form-item>
                        </template>
                    </el-col>
                </el-row>
