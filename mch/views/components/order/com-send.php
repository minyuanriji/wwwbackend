    ...
    Vue.component('com-send', {
        ...
        methods: {
            ...
            getExpressData() {
                ...
                // 默认全选
                self.orderDetail.forEach(row => {	//没有发货&&可以发货
                    if ((!row.expressRelation) && (!row.cant_send)) {
                        setTimeout(() => {	//获取表单，设置某行的选中状态
