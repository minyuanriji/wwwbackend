...
Yii::$app->loadComponentView('com-topic-detail');
?>
<style>
    .pic {
        height: 100px;
    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header" class="clearfix">
            ...
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'mall/topic/index'})" class="text">专题</span>/专题编辑</div>
                <div flex="dir:right">
                    <div>
                        <el-button class="button-item" type="primary" @click="onSubmit" :loading=btnLoading
                                   size="small">提交
                        </el-button>
                    </div>
                </div>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" style="background-color: #FFFFFF;padding: 20px;">
                ...
                <div class="form-body">
                    <el-form :model="form" label-width="10rem" v-loading="loading" :rules="FormRules" ref="form">
                        ...
                        <el-form-item label="封面图" prop="cover_pic" size="small">
                            <com-attachment @selected="coverUrl" :multiple="form.layout == 2">
                            ...
                            <com-image width="80px" height="80px" mode="aspectFill" :src="form.cover_pic"
                                       v-if="form.layout != 2"></com-image>
                        ...
                        <el-form-item label="自定义分享图片">
                            <com-attachment v-model="form.qrcode_pic" :multiple="false" :max="1">
            ...
            <el-tab-pane label="详情设置" name="second">
                <div style="padding-bottom: 40px;" v-if="form.detail">
                    <com-topic-detail v-model="form.detail"></com-topic-detail>
                </div>
            </el-tab-pane>
        </el-tabs>
        <!--        <div class="button">-->
