                ...
                <div v-for="item in cList" style="padding: 10px;" :style="cItemStyle">
                    <div class="goods-item"
                        ...
                        <div class="goods-pic" :style="cGoodsPicStyle(item.picUrl)">
                            <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-seckill-timer"
...
<script>
    Vue.component('diy-seckill', {
        template: '#diy-seckill',
        props: {
            value: Object,
        },
        data() {
...
<style>
    .diy-seckill .diy-component-edit .goods-list {
        line-height: normal;
        flex-wrap: wrap;
    }

    .diy-seckill .diy-component-edit .goods-item,
    .diy-seckill .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
    ...
    .diy-seckill .diy-component-edit .goods-delete {
        position: absolute;
        top: -11px;
        right: -11px;
        width: 25px;
    ...
    .diy-seckill .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-------------------- 预览部分 --------------------*/
    .diy-seckill .diy-component-preview .goods-list {
        flex-wrap: wrap;
        background-color: #fff;
        padding: 10px;
    }

    .diy-seckill .diy-component-preview .goods-item {
        position: relative;
    }

    .diy-seckill .diy-component-preview .goods-tag {
        position: absolute;
        top: 0;
        left: 0;
        width: 64px;
    ...
    .diy-seckill .diy-component-preview .goods-pic {
        width: 100%;
        height: 706px;
    ...
    .diy-seckill .diy-component-preview .goods-name {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
    }

    .diy-seckill .diy-component-preview .goods-cover-3-2 .goods-pic {
        height: 470px;
    }

    .diy-seckill .diy-component-preview .goods-list-2 .goods-pic {
        height: 343px;
    }

    .diy-seckill .diy-component-preview .goods-list--1 .goods-pic {
        width: 200px;
        height: 200px;
        margin-right: 20px;
    }

    .diy-seckill .diy-component-preview .goods-list--1 .goods-item {
        margin-bottom: 20px;
    }

    .diy-seckill .diy-component-preview .goods-list--1 .goods-item:last-child {
        margin-bottom: 0;
    }

    .diy-seckill .diy-component-preview .goods-name-static {
        white-space: normal;
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
    ...
    .diy-seckill .diy-component-preview .goods-price {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
        color: #ff4544;
    ...
    .diy-seckill .diy-component-preview .goods-seckill-timer {
        position: absolute;
        left: 0;
        right: 0;
        bottom: 0;
