                                        ...
                                        <el-form-item label="商品信息获取" width="120">
                                            ...
                                            <div>
                                                <el-row type="flex">
                                                    ...
                                                    <com-select-goods :multiple="false"
                                ...
                                <el-col :xl="12" :lg="16">
                                    <template v-if="is_attr == 1">
                                        ...
                                        <el-form-item prop="goods_num"  id="goods_aera">
                                            ...
                                            <div style="width:130%">
                                                <com-attr-group @select="makeAttrGroup"
                                                                v-model="attrGroups"></com-attr-group>
                                            </div>
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <el-form-item prop="freight_id" v-if="is_form == 1">
                                        ...
                                        <com-goods-form v-model="ruleForm.form" @selected="selectForm"
                                                        title="选择表单"
                                                        url="mall/order-form/all-list"></com-goods-form>
                                    </el-form-item>
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <el-form-item prop="fulfil_price">
                                        ...
                                        <el-input type="number"
                                                  oninput="this.value = this.value.replace(/[^0-9\.]/, '');" min="0"
                                                  placeholder="请输入金额" v-model="ruleForm.fulfil_price">
                                            <template slot="append">元</template>
                                        </el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item prop="full_relief_price">
                                        ...
                                        <el-input type="number"
                                                  oninput="this.value = this.value.replace(/[^0-9\.]/, '');" min="0"
                                                  placeholder="请输入金额" v-model="ruleForm.full_relief_price">
                                            <template slot="append">元</template>
                                        </el-input>
                                    </el-form-item>
                            ...
                            <template v-if="ruleForm.is_level_alone == 1">
                                <template v-if="ruleForm.use_attr == 1 && memberLevel.length > 0">
                                    ...
                                    <el-form-item label="会员价设置">
                                        <com-attr v-model="ruleForm.attr" :attr-groups="attrGroups"
                                                  :members="memberLevel" :is-level="true"></com-attr>
                                    </el-form-item>
                                </template>
                                <!-- 无规格默认会员价 -->
...
<script>
    Vue.component('group-buy-com-goods', {
        template: '#abc',
        props: {
            // 选择分类  0--不显示 1--显示可编辑
            is_cats: {
        ...
        methods: {
            ...
            fullForeheadScore() {
                this.ruleForm.forehead_score = 100;
                this.ruleForm.forehead_score_type = 2;
                this.ruleForm.accumulative = this.ruleForm.full_forehead_score;
            },
            //检查是否积分全额抵扣
            checkFullForeheadScore() {
                if (this.ruleForm.forehead_score == 100.00 &&
                    this.ruleForm.forehead_score_type == 2 &&
