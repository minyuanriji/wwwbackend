...
include_once ('AlibabaTradeGetBuyerViewParam/AlibabaTradeSkuItemDesc.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$skuInfosResult=$arrayResult['skuInfos'];
    			...
    			$this->gmtPayExpireTime = $arrayResult['gmtPayExpireTime'];
    			}
    			...
    			$this->subItemIDString = $arrayResult['subItemIDString'];
    			}
    		    	    			    		    			if (array_key_exists ( "refundIdForAs", $this->arrayResult )) {
    			$this->refundIdForAs = $arrayResult['refundIdForAs'];
    			}
    		    	    			    		    			if (array_key_exists ( "erpMaterialCode", $this->arrayResult )) {
    			$this->erpMaterialCode = $arrayResult['erpMaterialCode'];
    			}
    			...
    			$this->cantSendReason = $arrayResult['cantSendReason'];
    			}
    		    	    			    		    			if (array_key_exists ( "canSendGoods", $this->arrayResult )) {
    			$this->canSendGoods = $arrayResult['canSendGoods'];
    			}
    		    	    		}
