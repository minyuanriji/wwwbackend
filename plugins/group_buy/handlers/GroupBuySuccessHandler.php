...
class GroupBuySuccessHandler extends BaseHandler
{
    public function register()
    {
        \Yii::$app->on(PluginGroupBuyActive::EVENT_GROUP_BUY_ACTIVE_SUCCESS, function ($event) {
            ...
            foreach ($plugin_group_buy_active->activeItems as $active_item) {
                ...
                $ActiveServices->sendWechatTempSuccess($active_item);
            }
        });
    }
}
