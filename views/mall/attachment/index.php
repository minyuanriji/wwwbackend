                                        ...
                                        <el-menu-item :index="'' + index" @click="switchGroup(index)">
                                            <div flex="dir:left box:last">
                                                ...
                                                <div v-if="is_recycle" flex="dir:left">
                                                    <el-button @click.stop="deleteGroup(index,2)" type="text">还原
                                                    </el-button>
                                                    <div style="color:#409EFF;margin:0 2px">|</div>
                                                    <el-button type="text" @click.stop="deleteGroup(index,3)">删除
                                                    </el-button>
                                                </div>
                                    ...
                                    <template v-for="(item, index) in attachments">
                                        <el-tooltip class="item" effect="dark" :content="item.name" placement="top"
                                            ...
                                            <div :key="index" :class="'material-item'+(item.selected ?' selected':'')"
                                                ...
                                                <!-- 图片 -->
                                                <img v-if="item.type == 'image'" class="material-img"
                                                     :src="item.thumb_url"
                                                     style="width: 140px;height: 140px;">
                                                <!-- 视频 -->
                                                <div v-if="item.type ==  'video'" class="material-img"
                                                     style="width: 140px;height: 140px;position: relative">
                                                    <div v-if="item.thumb_url" class="material-video-cover"
                                                         :style="'background-image: url('+item.thumb_url+');'"></div>
                                                ...
                                                <!-- 文件 -->
                                                <div v-if="item.type == 'doc'" class="material-img"
