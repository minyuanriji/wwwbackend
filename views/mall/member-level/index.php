        ...
        <div class="table-body">
            ...
            <el-table
                ...
                <el-table-column
                        label="折扣">
                    <template slot-scope="scope">
                        <com-ellipsis :line="1">{{scope.row.discount}}</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="购买价格(元)">
                    <template slot-scope="scope">
                        <com-ellipsis v-if="scope.row.is_purchase == 1" :line="1">{{scope.row.price}}</com-ellipsis>
                        <com-ellipsis v-else :line="1">未启用</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="累计金额升级条件(元)">
                    <template slot-scope="scope">
                        <com-ellipsis v-if="scope.row.auto_update == 1" :line="1">{{scope.row.money}}</com-ellipsis>
                        <com-ellipsis v-else :line="1">未启用</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            switchStatus(row) {
                ...
                request({
                    params: {
                        r: 'mall/member-level/switch-status',
                    },
                    method: 'post',
                    data: {
                        id: row.id,
