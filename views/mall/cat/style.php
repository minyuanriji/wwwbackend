                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="一级分类样式" name="first">
                            <div class="cat-style"
                                ...
                                <div class="cat-bg">
                                    <com-image :src="item.pic_url"
                                               style="height:500px;line-height:500px;width:280px;"></com-image>
                                </div>
                                <com-image v-if="item.value == form.cat_style"
                                           style="position: absolute;top: 0px;left: 0px;z-index:99" width="80px"
                                           height="80px" :src="cat_select"></com-image>
