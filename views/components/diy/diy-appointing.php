...
<template id="diy-appointing">
    <div class="diy-appointing">
...
<script>
    Vue.component('diy-appointing', {
        template: '#diy-appointing',
        props: {
            value: Object,
        },
        data() {
...
<style>
    .diy-appointing .diy-component-edit .goods-list {
        line-height: normal;
        flex-wrap: wrap;
    }

    .diy-appointing .diy-component-edit .goods-item,
    .diy-appointing .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
    ...
    .diy-appointing .diy-component-edit .goods-delete {
        position: absolute;
        top: -11px;
        right: -11px;
        width: 25px;
    ...
    .diy-appointing .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-------------------- 预览部分 --------------------*/
    .diy-appointing .diy-component-preview .goods-list {
        flex-wrap: wrap;
        background-color: #fff;
        padding: 10px;
    }

    .diy-appointing .diy-component-preview .goods-item {
        position: relative;
    }

    .diy-appointing .diy-component-preview .goods-tag {
        position: absolute;
        top: 0;
        left: 0;
        width: 64px;
    ...
    .diy-appointing .diy-component-preview .goods-pic {
        width: 100%;
        height: 706px;
    ...
    .diy-appointing .diy-component-preview .goods-name {
        margin-bottom: 18px;
        white-space: nowrap;
        overflow: hidden;
    ...
    .diy-appointing .diy-component-preview .goods-cover-3-2 .goods-pic {
        height: 470px;
    }

    .diy-appointing .diy-component-preview .goods-list-2 .goods-pic {
        height: 343px;
    }

    .diy-appointing .diy-component-preview .goods-list--1 .goods-pic {
        width: 200px;
        height: 200px;
        margin-right: 20px;
    }

    .diy-appointing .diy-component-preview .goods-list--1 .goods-item {
        margin-bottom: 20px;
    }

    .diy-appointing .diy-component-preview .goods-list--1 .goods-item:last-child {
        margin-bottom: 0;
    }

    .diy-appointing .diy-component-preview .goods-name-static {
        height: 130px;
        padding: 10px 0;
        white-space: normal;
        overflow: hidden;
    ...
    .diy-appointing .diy-component-preview .goods-price {
        color: #ff4544;
        line-height: 48px;
    }

    .diy-appointing .diy-component-preview .buy-btn {
        border-color: #ff4544;
        color: #ff4544;
        padding: 0 20px;
        height: 48px;
    ...
    .diy-appointing .diy-component-preview .buy-btn.el-button--primary {
        background-color: #ff4544;
        color: #fff;
    }

    .diy-appointing .diy-component-preview .goods-item .buy-btn.is-round {
        border-radius: 24px;
    }
</style>