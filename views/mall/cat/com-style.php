...
<style>
    .com-style .table-body {
        padding: 0;
        background-color: #fff;
    }

    .com-style .el-card__body {
        padding: 0;
    }

    .com-style .cat-style .text {
        cursor: pointer;
        background: #409eff;
        width: 90px;
        color: #fff;
    ...
    .com-style .cat-style-nmodel {
        background-color: transparent;
    }

    .com-style .button-item {
        padding: 9px 25px;
        margin-top: 20px;
    }
    ...
    .com-style .tab-box .active {
        background: #409eff;
        color: #FFFFFF;
    }
</style>

<template id="com-style">
    <div class="com-style">
                ...
                <el-card shadow="never" style="border:0;">
                    <el-row class="table-body">
                        <div class="tab-box" flex="dir:left">
                            <div :class="{'active': activeName == 'one' ? true : false}" class="btn"
                                 @click="handleClick('one')">一级分类样式
                            </div>
                            <div :class="{'active': activeName == 'two' ? true : false}" class="btn"
                                 @click="handleClick('two')">二级分类样式
                            </div>
                            <div :class="{'active': activeName == 'three' ? true : false}" class="btn"
                                 @click="handleClick('three')">三级分类样式
                            </div>
                        </div>
