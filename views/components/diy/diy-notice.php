    ...
    <div>
        <div class="diy-component-preview">
            <div class="diy-notice" :style="cStyle" flex="dir:left cross:center">
                ...
                <img src="'<?=$diyIconPath?>/icon-left-arrow.png" style="width: 10px;height: 18px;">
            </div>
        </div>
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item label="公告图标">
                    ...
                    <com-gallery :list="[{url:data.icon}]" :show-delete="false"
                ...
                <div>
                    <el-form label-width="100px" @submit.native.prevent>
                        <el-form-item label="头部图片">
                            ...
                            <com-gallery :url="data.headerUrl" :show-delete="false"
                                         @deleted="deletePic('headerUrl')"></com-gallery>
                        </el-form-item>
        ...
        data() {
            return {
                data: {
                    name: '公告',
                    content: '',
                    icon: '<?=$diyIconPath?>/components/icon-notice.png',
                    textColor: '#ffffff',
                    background: '#f67f79',
                    headerUrl: '<?=$diyIconPath?>/components/icon-notice-title.png',
                    btnColor: '#ff4544',
                    btnWidth: 500,
                    btnHeight: 80,
                    btnRadius: 40,
