        ...
        <div class="table-body">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;">
                    ...
                    <el-table-column label="结算月" prop="month" width="200"></el-table-column>
                    <el-table-column label="上月团队新增人数" prop="team_new_count" width="200"></el-table-column>
    ...
    const app = new Vue({
        ...
        methods: {
            loadData() {
                this.loading = true;
                let params = {
                    r: 'plugin/distribution/mall/distribution/subsidy-list'
                };
