...
<template id="com-edit-template">
    <div class="com-edit-template">
        <!-- 添加评价回复模板 -->
...
<script>
    Vue.component('com-edit-template', {
        template: '#com-edit-template',
        props: {
            isShow: {
                type: Boolean,
                default: false,
            ...
            url: {
                type: String,
                default: 'mch/order-comment-templates/edit'
            }
        },
        watch: {
