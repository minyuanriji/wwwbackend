<style>
    ...
    .com-market .dialog-img .choose-btn {
        cursor: pointer;
        border-radius: 6px;
        height: 40px;
        line-height: 38px;
    ...
    .com-market .choose-btn.use {
        border: 1px solid #3399ff;
        background-color: #3399ff;
    }
</style>
<template id="com-market">
    <div class="com-market">
