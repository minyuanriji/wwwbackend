    ...
    <div>
        <header class="mall-header" flex="box:last">
            ...
            <el-menu mode="horizontal" menu-trigger="click">
                <el-menu-item v-if="mch_id == 0" @click="navigateClick({r: 'mch/cache/clean', '_layout': 'mall'})" index="3">缓存
                </el-menu-item>
                ...
                <el-submenu index="2" v-if="mall && user" popper-class="mall-header-menu">
                    <template slot="title">
                        <span :title="user.username" class="mall-name">{{user.username}}</span>
                    </template>
