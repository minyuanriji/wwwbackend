...
/**
 * This is the model class for table "{{%plugin_boss_price_log_type}}".
 *
 * @property int $id
 ...
 * @property int $type 0、股东提成 1、平级奖 2、越级奖
 */
class BossPriceLogType extends BaseActiveRecord
{
    ...
    {
        return '{{%plugin_boss_price_log_type}}';
    }
