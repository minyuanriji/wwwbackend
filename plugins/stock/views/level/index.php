        ...
        <div slot="header">
            <div>
                ...
                <div style="float: right; margin: -5px 0">
                    <el-button type="primary" @click="$navigate({r: 'plugin/stock/mall/level/edit'})" size="small">添加代理商等级</el-button>
                </div>
            </div>
        </div>
        <div class="table-body">
            <el-table
                ...
                <el-table-column label="权重" >
                    <template slot-scope="scope">
                        <com-ellipsis :line="1">{{scope.row.level}}</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column label="代理商等级名称" >
                    <template slot-scope="scope">
        ...
        methods: {
            ...
            levelDelete(row, index) {
                ...
                self.$confirm('删除该代理商等级, 是否继续?', '提示', {
                    ...
                    request({
                        params: {
                            r: 'plugin/stock/mall/level/delete',
                        },
                        method: 'post',
                        data: {
                            id: row.id,
