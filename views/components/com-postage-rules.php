...
<div id="com-postage-rules" v-cloak>
        ...
        <div class="table-body">
            <div style="justify-content:space-between;display: flex">
                ...
                <el-button style="margin: -5px 0;width: 80px; height: 32px;" type="primary" size="small"
                           @click="$navigate({r:'mall/postage-rules/edit'})">添加规则
                </el-button>
            </div>
...
<script>
    Vue.component('com-postage-rules', {
        template: '#com-postage-rules',
        data() {
            return {
                list: [],
                listLoading: false,
