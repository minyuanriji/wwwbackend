        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="导航图标">
                    <com-image-upload v-model="data.navPicUrl" width="50" height="50"></com-image-upload>
                </el-form-item>
                <el-form-item label="评分图标">
                    <com-image-upload v-model="data.scorePicUrl" width="20" height="20"></com-image-upload>
                </el-form-item>
