...
<style>
    .com-transfer .transfer {
        width: 280px;
        height: 500px;
    }

    .com-transfer .transfer .cat-header {
        padding: 0 16px;
        height: 40px;
        line-height: 40px;
    ...
    .com-transfer .transfer .cat-body {
        overflow-y: auto;
        height: 460px;
        padding: 16px;
        width: 100%;
    ...
    .com-transfer .transfer .cat-next {
        color: #353535;
        text-align: right;
        font-size: 10px;
        padding: 0;
...
<template id="com-transfer">
    <div class="com-transfer">
...
<script>
    Vue.component('com-transfer', {
        template: '#com-transfer',
        props: {
