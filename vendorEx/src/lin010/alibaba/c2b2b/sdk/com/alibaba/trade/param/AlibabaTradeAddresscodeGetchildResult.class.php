...
include_once ('AlibabaTradeAddresscodeGetchildParam/AlibabaTradeAddressCode.class.php');

class AlibabaTradeAddresscodeGetchildResult {
    ...
    */
     ...
     * @param array include @see AlibabaTradeAddressCode[] $result     
		...
		$this->stdResult = $stdResult;
    			...
    			$resultResult=$this->stdResult->{"result"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$AlibabaTradeAddressCodeResult=new AlibabaTradeAddressCode();
						$AlibabaTradeAddressCodeResult->setArrayResult($arrayobject );
						$this->result [$i] = $AlibabaTradeAddressCodeResult;
					}
    			}
