...
class Delivery extends BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'mch_id', 'express_id', 'is_sms', 'is_delete', 'is_goods'], 'integer'],
            [['customer_account', 'customer_pwd', 'month_code', 'outlets_name', 'outlets_code', 'company', 'name', 'tel', 'mobile', 'zip_code', 'province', 'city', 'district', 'address', 'template_size'], 'string', 'max' => 255],
        ];
    }
