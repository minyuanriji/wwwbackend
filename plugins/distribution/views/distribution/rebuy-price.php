        ...
        <div class="table-body">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;">
                    ...
                    <el-table-column label="结算金额" prop="total_order_price" width="200"></el-table-column>
                    <el-table-column label="结算商品数量" prop="total_order_goods_num" width="200"></el-table-column>
    ...
    const app = new Vue({
        ...
        methods: {
            loadData() {
                this.loading = true;
                let params = {
                    r: 'plugin/distribution/mall/distribution/rebuy-price-list'
                };
