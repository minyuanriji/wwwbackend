            ...
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="130px">
                ...
                <template>
                    <el-form-item label="商品图片" prop="pic_url" >
                        <com-attachment v-if="!isDisabled" :multiple="false" :max="1" v-model="ruleForm.pic_url">
                        ...
                        <com-gallery :url="ruleForm.pic_url" :show-delete="isDisabled ? false : true" @deleted="ruleForm.pic_url = ''"
