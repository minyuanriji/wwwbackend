        ...
        <div class="diy-component-edit">
            <el-form @submit.native.prevent label-width="150px">
                ...
                <el-form-item label="商品角标样式" v-if="data.showGoodsTag">
                    <com-radio v-model="data.goodsTagPicUrl" v-for="tag in goodsTags" :label="tag.picUrl" :key="tag.name"
                ...
                <el-form-item label="自定义商品角标" v-if="data.showGoodsTag&&data.customizeGoodsTag">
                    <com-image-upload width="64" height="64" v-model="data.goodsTagPicUrl"></app-image-upload>
                </el-form-item>
