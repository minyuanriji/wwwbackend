...
Yii::$app->loadComponentView('diy/diy-nav-select');
?>
<style>
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px">
                ...
                <el-form-item label="滑动设置">
                    <com-radio v-model="data.navType" label="fixed">固定</com-radio>
                    <com-radio v-model="data.navType" label="alone">单行滑动</com-radio>
                    <com-radio v-model="data.navType" label="multi">多行滑动</com-radio>
                </el-form-item>
                ...
                <el-table v-loading="listLoading" :data="navList" ref="multipleTable"
                    ...
                    <el-table-column label="导航链接">
                        <template slot-scope="scope">
                            <com-ellipsis :line="1">{{scope.row.url}}</com-ellipsis>
                        </template>
                    </el-table-column>
                </el-table>
