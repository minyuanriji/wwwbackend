<?php
echo $this->render('../components/com-kdniao');
echo $this->render('../components/com-postage-rules');
echo $this->render('../components/com-free-delivery-rules');
echo $this->render('../components/com-offer-price');
?>
    ...
    <el-card style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;" v-loading="loading">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="运费规则" name="second">
                <el-row>
                    <el-col :span="24">
                        <com-postage-rules></com-postage-rules>
                    </el-col>
                </el-row>
            </el-tab-pane>
            <el-tab-pane label="包邮规则" name="third">
                <el-row>
                    <el-col :span="24">
                        <com-free-delivery-rules></com-free-delivery-rules>
                    </el-col>
                </el-row>
            </el-tab-pane>
            <el-tab-pane label="起送规则" name="fourth">
                <el-row>
                    <el-col :span="24">
                        <com-offer-price></com-offer-price>
                    </el-col>
                </el-row>
            </el-tab-pane>
        </el-tabs>
