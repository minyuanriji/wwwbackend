                    ...
                    <div>
                        <el-form @submit.native.prevent>
                                ...
                                <div style="border: 1px solid #e2e2e2;padding: 5px;margin-bottom: 5px;line-height: normal;max-width: 400px" v-for="(item,index) in data.list">
                                    ...
                                    <div flex="box:first">
                                        <div style="margin-right: 10px">
                                            <com-image-upload v-model="item.picUrl"></com-image-upload>
                                        </div>
                            ...
                            <el-form-item v-if="data.opened" label="弹窗次数">
                                <com-radio v-model="data.times" :label="0">每次</com-radio>
                                <com-radio v-model="data.times" :label="1">仅首次</com-radio>
                            </el-form-item>
