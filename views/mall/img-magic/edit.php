    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;" v-loading="cardLoading">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'mall/img-magic/index'})">图片魔方列表</span></el-breadcrumb-item>
                ...
                <el-form-item label="板块设置">
                    <template v-if="ruleForm.value.length > 0">
                        <el-row v-for="(item,index) in ruleForm.value"
                            ...
                            <el-col :span="4">
                                <com-attachment :multiple="false" :max="1" :params="{'index':index}" @selected="picUrl">
                                ...
                                <com-image width="80px" height="80px" mode="aspectFill" :src="item.pic_url"></com-image>
                            </el-col>
                            <el-col :span="10">
                                <div flex="box:last">
                                    <el-input disabled v-model="item.link.new_link_url" v-if="item.link"></el-input>
                                    <com-pick-link :params="{'index': index}" @selected="selectLinkUrl">
