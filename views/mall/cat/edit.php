    ...
    <el-card shadow="never" style="border:0" class="box-card" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div slot="header">
            <div flex="cross:center box:first">
                <div><span @click="$navigate({r:'mall/cat/index'})" class="text">分类</span>/分类编辑</div>
                <div flex="dir:right">
                    <div>
        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="120px">
                ...
                <el-form-item prop="pic_url">
                    ...
                    <com-attachment :multiple="false" :max="1" v-model="ruleForm.big_pic_url">
                        <el-tooltip effect="dark" content="建议尺寸702*212" placement="top">
                            <el-button style="margin-bottom: 10px;" size="mini">选择文件</el-button>
                        </el-tooltip>
                    </com-attachment>
                    <com-gallery :url="ruleForm.big_pic_url" :show-delete="true"
                ...
                <template v-if="!is_mch">
                    <el-form-item prop="advert_pic">
                        ...
                        <com-attachment :multiple="false" :max="1" v-model="ruleForm.advert_pic">
                            <el-tooltip effect="dark" content="建议尺寸500*184" placement="top">
                                <el-button style="margin-bottom: 10px;" size="mini">选择文件</el-button>
                            </el-tooltip>
                        </com-attachment>
                        <com-gallery :url="ruleForm.advert_pic" :show-delete="true"
                    ...
                    <el-form-item label="分类广告链接" prop="advert_url">
                        <div flex="box:last">
                            ...
                            <com-pick-link @selected="selectAdvertUrl">
