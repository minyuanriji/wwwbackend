 ...
 * @property int $distribution_order_id 分销订单id
 ...
 * @property DistributionOrder $distributionOrder
 */
class DistributionCommissionLog extends BaseActiveRecord
{
    ...
    {
        return '{{%plugin_distribution_commission_log}}';
    }
    ...
    {
        return [
            [['user_id', 'mall_id', 'type', 'money','commission', 'desc','distribution_order_id', 'created_at'], 'required'],
            [['user_id', 'mall_id', 'type','level','distribution_order_id','status','order_id','is_pay'], 'integer'],
    ...
    public function getDistributionOrder()
    {
        return $this->hasOne(DistributionOrder::className(), ['id' => 'distribution_order_id']);
    }
}
