        ...
        <div class="table-body">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <com-ellipsis :line="2">{{scope.row.address}}</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="备注">
                    <template slot-scope="scope">
                        <com-ellipsis :line="2">{{scope.row.remark}}</com-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="操作">
