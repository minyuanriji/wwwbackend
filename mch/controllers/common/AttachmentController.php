<?php
namespace app\mch\controllers\common;

use app\core\ApiCode;
use app\mch\controllers\BaseController;
use app\mch\forms\common\attachment\CommonAttachment;
use app\mch\forms\common\GroupUpdateForm;
...
class AttachmentController extends BaseController{
    ...
    public function actionUpload($name = 'image'){
        ...
        $result = CommonAttachment::addAttachmentInfo(1, $mall->id,$mall->admin_id, $group_id);
        return $result;
    }
     ...
     * 附件列表
     * @param int $page
     * @param int|null $attachment_group_id
     * @param string $type
     * @param bool|null $is_recycle
