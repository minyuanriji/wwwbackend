        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="130px">
                ...
                <el-form-item label="直播背景图" prop="cover_img" >
                    <com-attachment :multiple="false" :max="1" v-model="ruleForm.cover_img">
                    ...
                    <com-gallery :url="ruleForm.cover_img" :show-delete="true" @deleted="ruleForm.cover_img = ''"
                                 width="80px" height="80px">
                    </com-gallery>
                </el-form-item>
                <el-form-item label="直播分享图" prop="share_img" >
                    <com-attachment :multiple="false" :max="1" v-model="ruleForm.share_img">
                        <el-tooltip effect="dark" content="建议像素800*640,大小不超过1M" placement="top">
                            <el-button style="margin-bottom: 10px;" size="mini">选择图片</el-button>
                        </el-tooltip>
                    </com-attachment>
                    <com-gallery :url="ruleForm.share_img" :show-delete="true" @deleted="ruleForm.share_img = ''"
                                 width="80px" height="80px">
                    </com-gallery>
                </el-form-item>
