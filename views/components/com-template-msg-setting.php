...
<template id="com-template-msg-setting">
...
<script>
Vue.component('com-template-msg-setting', {
    template: '#com-template-msg-setting',
    data() {
        return {
            dialogImgUrl: '',
            dialogVisible: false,
        ...
        onSubmit() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    request({
                        params: {
                            r: 'mall/setting/template'
                        },
                        data: para,
                        method: 'post'
                    }).then(e => {
                        if (e.data.code === 0) {
                            navigateTo({ r: 'mall/setting/notice' });
                        } else {
                            this.$message.error(e.data.msg);
                        }
