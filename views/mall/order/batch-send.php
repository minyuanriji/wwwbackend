        ...
        <div class="form-body">
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                <el-form-item label="导入模板" prop="url" style="min-width: 600px">
                    <div>
                        <com-upload v-loading="uploading" :disabled="uploading" @start="handleStart" @success="handleSuccess" @complete="handleComplete" :max="1" accept=".csv" style="width: 60%;float: left;margin-right: 20px;">
