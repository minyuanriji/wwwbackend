...
class UserIncomeCommissionAddcredit3rForm extends UserIncomeForm
{
    /**
     * 取消推荐酒店订单待结算收益
     ...
     * @param CommissionAddcredit3rPriceLog $priceLog
     * @param false $trans
     * @return array
     */
    public static function AddcreditCommissionFzAdd(User $user, AddcreditOrder $addcreditOrder, CommissionAddcredit3rPriceLog $priceLog, $trans = false)
    {
        $trans && ($t = \Yii::$app->db->beginTransaction());
        try {
            ...
            static::change($user, $priceLog->price, self::TYPE_ADD, self::FLAG_INCOME, "addcredit_3r", $priceLog->id, $desc);
