 ...
 */
Yii::$app->loadComponentView('goods/app-select-coupon-two');
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                <el-form-item label="添加方式">
                    <com-radio v-model="data.addType" label="manual">手动添加</com-radio>
                    <com-radio v-model="data.addType" label="">自动添加</com-radio>
                ...
                <el-form-item label="背景效果">
                    <com-radio v-model="data.couponBgType" label="pure">纯色</com-radio>
                    <com-radio v-model="data.couponBgType" label="gradient">渐变</com-radio>
                </el-form-item>
