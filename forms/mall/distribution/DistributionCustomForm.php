...
class DistributionCustomForm extends BaseModel
{
    public $data;
    ...
    public function saveData()
    {
        ...
        OptionLogic::set(Option::NAME_SHARE_CUSTOMIZE, $this->data, \Yii::$app->mall->id, 'api');
        return [
...
//      $default = $this->getBonus($default);
        $data = OptionLogic::get(Option::NAME_SHARE_CUSTOMIZE, \Yii::$app->mall->id, 'api', $default);
    ...
    {
        $iconUrlPrefix = \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/img/mall/area-custom/';
