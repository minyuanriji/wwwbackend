...
<div id="app" v-cloak>
    <el-card shadow="never">
        ...
        <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
            ...
            <el-table-column prop="admin.username" label="账户" width="150"></el-table-column>
            <el-table-column prop="name" label="商城名称"></el-table-column>
            <el-table-column label="操作" width="180">
                <template slot-scope="scope">
                    <el-button size="mini" @click="unsetRecycle(scope.row)">恢复</el-button>
                    <el-button size="mini" type="danger" @click="setDelete(scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <div flex="box:last cross:center">
            <div style="visibility: hidden">
                ...
                <el-button plain type="danger" size="small">2</el-button>
            </div>
            <div>
                <el-pagination
                        v-if="pagination"
