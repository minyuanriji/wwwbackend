<?php
echo $this->render('../components/order/com-search');
echo $this->render('../components/order/com-edit-address');
echo $this->render('../components/order/com-edit-seller-remark');
echo $this->render('../components/order/com-clerk');
echo $this->render('../components/order/com-send');
echo $this->render('../components/order/com-cancel');
echo $this->render('../components/order/com-edit-price');
echo $this->render('../components/order/com-city');
?>
<style>
...
<script>
    Vue.component('com-order', {
        ...
        props: {
            ...
            orderUrl: {
                type: String,
                default: 'mch/order/index',
            },
            // 删除回收站请求URl
            recycleUrl: {
                type: String,
                default: 'mch/order/destroy-all',
            },
            // 订单详情URL
            orderDetailUrl: {
                type: String,
                default: 'mch/order/detail'
            },
            // 修改备注请求URL
            editRemarkUrl: {
                type: String,
                default: 'mch/order/seller-remark'
            },
            // 控制按钮是否显示
            // 编辑收货地址
            isShowEditAddress: {
