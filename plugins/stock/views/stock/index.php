 ...
 * Time: 15:48
 */
Yii::$app->loadPluginComponentView('stock-batch');
Yii::$app->loadPluginComponentView('stock-edit');
Yii::$app->loadPluginComponentView('stock-level');
?>
...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
           ...
           <!-- <div class="batch">
                <stock-batch :choose-list="choose_list" :stock-level-list="agentLevelList"
                           @to-search="loadData"></stock-batch>
            </div>-->
            <div style="float: right">
                <el-button type="primary" size="small" style="padding: 9px 15px !important;" @click="editClick">添加代理商
                </el-button>
            </div>
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-table :data="list" border v-loading="loading" size="small" style="margin-bottom: 15px;"
                    ...
                    <el-table-column label="代理商等级" width="120" prop="level">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="时间" width="200">
                        <template slot-scope="scope">
                            <div>成为代理商时间：<br>{{scope.row.created_at|dateTimeFormat('Y-m-d H:i:s')}}</div>
                        </template>
                    </el-table-column>
                    </el-table-column>
                        ...
                        <template slot-scope="scope">
                            <el-button type="text" size="mini" circle style="margin-top: 10px"
                                ...
                                <el-tooltip class="item" effect="dark" content="查看订单" placement="top">
                                    <img src="statics/img/mall/stock/order.png" alt="">
                                </el-tooltip>
                            </el-button>
                            <el-button type="text" size="mini" circle style="margin-left: 10px;margin-top: 10px"
                                ...
                                <el-tooltip class="item" effect="dark" content="提现详情" placement="top">
                                    <img src="statics/img/mall/stock/detail.png" alt="">
                                </el-tooltip>
                            </el-button>
                            <el-button type="text" size="mini" circle style="margin-left: 10px;margin-top: 10px"
                            ...
                            <el-button type="text" size="mini" circle style="margin-left: 10px;margin-top: 10px"
                                ...
                                <el-tooltip class="item" effect="dark" content="修改代理商等级" placement="top">
    ...
    <stock-edit v-model="edit.show"></stock-edit>
    <stock-level v-model="level.show" :stock="level.stock" @success="levelSuccess"></stock-level>
</div>
<script>
    const app = new Vue({
        el: '#app',
        ...
        methods: {
            ...
            remarksSubmit() {
                ...
                request({
                    params: {
                        r: 'plugin/stock/mall/stock/remarks-edit',
                    },
                    method: 'post',
                    data:{
