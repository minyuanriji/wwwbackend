<style>
    ...
    .agent-batch .batch-box {
        margin-left: 10px;
    }

    .agent-batch .batch-remark {
        margin-top: 5px;
        color: #999999;
        font-size: 14px;
    }

    .agent-batch .select-count {
        font-size: 14px;
        margin-left: 10px;
    }

    .agent-batch .batch-title {
        font-size: 18px;
    }

    .agent-batch .batch-box-left {
        width: 120px;
        border-right: 1px solid #e2e2e2;
        padding: 0 20px;
    }

    .agent-batch .batch-box-left div {
        padding: 5px 0;
        margin: 5px 0;
        cursor: pointer;
    ...
    .agent-batch .batch-div-active {
        background-color: #e2e2e2;
    }

    .agent-batch .el-dialog__body {
        padding: 15px 20px;
    }

    .agent-batch .batch-box-right {
        padding: 5px 20px;
    }

    .agent-batch .express-dialog .el-dialog {
        min-width: 250px;
    }
</style>


<template id="agent-batch">
    <div class="agent-batch" flex="dir:left cross:center">
...
<script>
    Vue.component('agent-batch', {
        template: '#agent-batch',
        props: {
            // 列表选中的数据
            chooseList: {
                type: Array,
            ...
            batchLevelUrl: {
                type: String,
                default: 'plugin/agent/mall/agent/batch-level',
            },
