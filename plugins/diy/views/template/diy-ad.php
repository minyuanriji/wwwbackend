 ...
 * Time: 17:19
 */
Yii::$app->loadComponentView('goods/app-select-coupon');
?>
<template id="diy-ad">
    <div>
        ...
        <div class="diy-component-edit">
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item v-if="data.type === 'before-video'" label="视频播放链接" prop="video_url">
                    <el-input v-model="data.video_url" placeholder="请输入视频原地址或选择上传视频">
                        <template slot="append">
                            <com-attachment :multiple="false" :max="1" v-model="data.video_url" type="video">
                ...
                <el-form-item label="优惠券" prop="award_coupons"
                    ...
                    <com-select-coupon v-model="data.award_coupons">
