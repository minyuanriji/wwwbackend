...
class Identity extends Model implements IdentityInterface
{
    ...
    public function __construct(CloudUser $cloudUser, $config = [])
    {
    ...
    {
        $identity = null;
        $cloudUser = CloudUser::findOne($id);
        if($cloudUser)
        {
            $identity = new static($cloudUser);
        }
        return $identity;
    }
