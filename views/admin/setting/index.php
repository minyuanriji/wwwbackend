                ...
                <el-form-item label="站点logo">
                    <el-input disabled class="currency-width isAppend">
                        <template slot="append">
                            <com-upload @complete="updateSuccess" accept="image/vnd.microsoft.icon" :params="params" :simple="true">
            ...
            <el-form label-position="left" label-width="150px" :model="form" ref="form">
                ...
                <el-form-item label="LOGO图片URL">
                    <el-input class="currency-width isAppend" v-model="form.logo">
                        <template slot="append">
                            <com-attachment v-model="form.logo" :simple="true">
                ...
                <el-form-item label="客服电话">
                    <el-input class="currency-width" v-model="form.contact_tel"
                             >
                    </el-input>
                </el-form-item>
                <el-form-item label="客服地址">
                    <el-input class="currency-width" v-model="form.web_service_url"
                              placeholder="例如:https://www.baidu.com">
                    </el-input>
                </el-form-item>
                <el-form-item label="登录页背景图">
                    <el-input class="currency-width isAppend" v-model="form.passport_bg">
                        <template slot="append">
                            <com-attachment v-model="form.passport_bg" :simple="true">
                                <el-button>上传图片</el-button>
                            </com-attachment>
                        </template>
                    </el-input>
                ...
                <el-form-item label="管理页背景图">
                    <el-input class="currency-width isAppend" v-model="form.manage_bg">
                        <template slot="append">
                            <com-attachment v-model="form.manage_bg" :simple="true">
                                <el-button>上传图片</el-button>
                            </com-attachment>
                        </template>
                    </el-input>
                ...
                <el-form-item label="注册页背景图">
                    <el-input class="currency-width isAppend" v-model="form.registered_bg">
                        <template slot="append">
                            <com-attachment v-model="form.registered_bg" :simple="true">
                                <el-button>上传图片</el-button>
                            </com-attachment>
                        </template>
                    </el-input>
                ...
                <el-form-item label="注册页二维码">
                    ...
                    <el-input class="currency-width isAppend" v-model="form.qr1">
                        <template slot="append">
                            <com-attachment v-model="form.qr1" :simple="true">
                                <el-button>上传图片</el-button>
                            </com-attachment>
                        </template>
                    </el-input>
                    ...
                    <el-input class="currency-width isAppend" v-model="form.qr2">
                        <template slot="append">
                            <com-attachment v-model="form.qr2" :simple="true">
                                <el-button>上传图片</el-button>
                            </com-attachment>
                        </template>
                    </el-input>
                ...
                <el-form-item label="注册协议" style="width: 600px;">
                    <com-rich-text :simple-attachment="true" v-model="form.register_protocol"></com-rich-text>
                </el-form-item>
                <!-- 分割线 -->
