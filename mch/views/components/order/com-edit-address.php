...
<template id="com-edit-address">
    <div class="com-edit-address">
...
<script>
    Vue.component('com-edit-address', {
        template: '#com-edit-address',
        props: {
            order: {
                type: Object,
                default: function () {
