            ...
            <div class="table table-body">
                    ...
                    <div class="input-item">
                        <el-input @keyup.enter.native="search" size="small" placeholder="请输入搜索内容" v-model="keyword"
                            ...
                            <el-select size="small" v-model="type" slot="prepend" class="select">
                                <el-option key="1" label="发卡人/手机号" value="1"></el-option>
                                <el-option key="2" label="领取人/手机号" value="2"></el-option>
                                <el-option key="3" label="卡号(序列号)" value="3"></el-option>
                            </el-select>
                            <el-button slot="append" icon="el-icon-search" @click="search"></el-button>
                        </el-input>
                    </div>
                    <div class="batch" flex="dir:right">
                ...
                <el-tabs @tab-click="handleClick">
                    <el-table
                        ...
                        <el-table-column prop="serialize_no" label="卡号(序列号)" width="120"></el-table-column>
                        <el-table-column prop="use_code" label="兑换码" width="80"></el-table-column>
                        ...
                        <el-table-column prop="expire_time" label="有效期" width="160">
                            <template slot-scope="scope">
                                <div size="small">{{scope.row.expire_time|formatDate}}</div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="updated_at" label="生成时间" width="160">
                            <template slot-scope="scope">
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-popover
                                    ...
                                    trigger="hover">
                                    <img :src="scope.row.qr_code_base64" style="max-width:180px"/>
                                    <img slot="reference" :src="scope.row.qr_code_base64" style="max-height:59px;max-width: 100px">
                                </el-popover>
                            </template>
                        </el-table-column>
...
<script>
    const app = new Vue({
        ...
        methods: {
            ...
            exportConfirm(){
                navigateTo({
                    r: '/plugin/integral_card/admin/card/export-card-info',
            ...
            switchStatus(id,option,index) {
                ...
                request({
                    params: {
                        r: 'plugin/integral_card/admin/card/card-status',
                    },
                    method: 'post',
                    data: {
                        form: form,
